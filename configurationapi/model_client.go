...
type Client struct {
	...
	// Set to true to allow the authentication API redirectless flow to function without requiring any cookies.
	EnableCookielessAuthenticationApi *bool `json:"enableCookielessAuthenticationApi,omitempty" tfsdk:"enable_cookieless_authentication_api"`
	...
	ClientAuthentication         *ClientAuthentication `json:"clientAuthentication,omitempty" tfsdk:"client_authentication"`
	...
	JwtSecuredAuthorizationResponseModeSigningAlgorithm *string `json:"jwtSecuredAuthorizationResponseModeSigningAlgorithm,omitempty" tfsdk:"jwt_secured_authorization_response_mode_signing_algorithm"`
	...
	// Determines whether offline_access scope is required to issue refresh tokens by this client or not. 'SERVER_DEFAULT' is the default value.
	...
	// The tags assigned to this client.
	...
	AllowExclusiveScopes            []string      `json:"allowExclusiveScopes,omitempty" tfsdk:"allow_exclusive_scopes"`
...
// GetEnableCookielessAuthenticationApi returns the EnableCookielessAuthenticationApi field value if set, zero value otherwise.
func (o *Client) GetEnableCookielessAuthenticationApi() bool {
	if o == nil || IsNil(o.EnableCookielessAuthenticationApi) {
		var ret bool
		return ret
	}
	return *o.EnableCookielessAuthenticationApi
}

// GetEnableCookielessAuthenticationApiOk returns a tuple with the EnableCookielessAuthenticationApi field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Client) GetEnableCookielessAuthenticationApiOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableCookielessAuthenticationApi) {
		return nil, false
	}
	return o.EnableCookielessAuthenticationApi, true
}
...
// SetEnableCookielessAuthenticationApi gets a reference to the given bool and assigns it to the EnableCookielessAuthenticationApi field.
func (o *Client) SetEnableCookielessAuthenticationApi(v bool) {
	o.EnableCookielessAuthenticationApi = &v
}
...
func (o *Client) GetClientAuthentication() ClientAuthentication {
	if o == nil || IsNil(o.ClientAuthentication) {
...
// SetClientAuthentication gets a reference to the given ClientAuthentication and assigns it to the ClientAuthentication field.
...
// GetAllowExclusiveScopes returns the AllowExclusiveScopes field value if set, zero value otherwise.
func (o *Client) GetAllowExclusiveScopes() []string {
	if o == nil || IsNil(o.AllowExclusiveScopes) {
		var ret []string
		return ret
	}
	return o.AllowExclusiveScopes
}

// GetAllowExclusiveScopesOk returns a tuple with the AllowExclusiveScopes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Client) GetAllowExclusiveScopesOk() ([]string, bool) {
	if o == nil || IsNil(o.AllowExclusiveScopes) {
		return nil, false
	}
	return o.AllowExclusiveScopes, true
}
...
// SetAllowExclusiveScopes gets a reference to the given []string and assigns it to the AllowExclusiveScopes field.
func (o *Client) SetAllowExclusiveScopes(v []string) {
	o.AllowExclusiveScopes = v
}
...
func (o Client) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EnableCookielessAuthenticationApi) {
		toSerialize["enableCookielessAuthenticationApi"] = o.EnableCookielessAuthenticationApi
	}
	...
	if !IsNil(o.ClientAuthentication) {
	...
	if !IsNil(o.AllowExclusiveScopes) {
		toSerialize["allowExclusiveScopes"] = o.AllowExclusiveScopes
	}
