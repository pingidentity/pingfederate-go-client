...
*AdministrativeApiAPI* | [**GetCorsSettings**](docs/AdministrativeApiAPI.md#getcorssettings) | **Get** /administrativeApi/corsSettings | Get the settings of the current administrative api cors settings.
*AdministrativeApiAPI* | [**UpdateCorsSettings**](docs/AdministrativeApiAPI.md#updatecorssettings) | **Put** /administrativeApi/corsSettings | Update the administrative api cors settings.
...
*ClusterAPI* | [**GetClusterAdminNodeStatus**](docs/ClusterAPI.md#getclusteradminnodestatus) | **Get** /cluster/adminNode/status | Get this administrative console&#39;s role and synchronization status.
...
*KeyPairsSigningAPI* | [**LinkSigningPrivateKeyAndCert**](docs/KeyPairsSigningAPI.md#linksigningprivatekeyandcert) | **Post** /keyPairs/signing/link | Import a certificate to be used by PingFederate and link it to a private key that exists on an HSM.
...
*KeyPairsSslClientAPI* | [**LinkSslClientPrivateKeyAndCert**](docs/KeyPairsSslClientAPI.md#linksslclientprivatekeyandcert) | **Post** /keyPairs/sslClient/link | Import a certificate to be used by PingFederate and link it to a private key that exists on an HSM.
...
*KeyPairsSslServerAPI* | [**LinkSslServerPrivateKeyAndCert**](docs/KeyPairsSslServerAPI.md#linksslserverprivatekeyandcert) | **Post** /keyPairs/sslServer/link | Import a certificate to be used by PingFederate and link it to a private key that exists on an HSM.
...
*OauthAuthServerSettingsAPI* | [**GetCommonScopeGroups**](docs/OauthAuthServerSettingsAPI.md#getcommonscopegroups) | **Get** /oauth/authServerSettings/scopes/commonScopeGroups | Get the common scope groups.
*OauthAuthServerSettingsAPI* | [**GetCommonScopes**](docs/OauthAuthServerSettingsAPI.md#getcommonscopes) | **Get** /oauth/authServerSettings/scopes/commonScopes | Get the common scopes.
...
*OauthAuthServerSettingsAPI* | [**GetExclusiveScopeGroups**](docs/OauthAuthServerSettingsAPI.md#getexclusivescopegroups) | **Get** /oauth/authServerSettings/scopes/exclusiveScopeGroups | Get the exclusive scope groups.
*OauthAuthServerSettingsAPI* | [**GetExclusiveScopes**](docs/OauthAuthServerSettingsAPI.md#getexclusivescopes) | **Get** /oauth/authServerSettings/scopes/exclusiveScopes | Get the exclusive scopes.
...
*OauthCimdPoliciesAPI* | [**CreateCimdPolicy**](docs/OauthCimdPoliciesAPI.md#createcimdpolicy) | **Post** /oauth/cimd/policies | Create a new CIMD policy.
*OauthCimdPoliciesAPI* | [**DeleteCimdPolicy**](docs/OauthCimdPoliciesAPI.md#deletecimdpolicy) | **Delete** /oauth/cimd/policies/{id} | Delete a CIMD policy.
*OauthCimdPoliciesAPI* | [**GetCimdPolicies**](docs/OauthCimdPoliciesAPI.md#getcimdpolicies) | **Get** /oauth/cimd/policies | Get list of CIMD policies.
*OauthCimdPoliciesAPI* | [**GetCimdPolicy**](docs/OauthCimdPoliciesAPI.md#getcimdpolicy) | **Get** /oauth/cimd/policies/{id} | Find a CIMD policy by ID.
*OauthCimdPoliciesAPI* | [**UpdateCimdPolicy**](docs/OauthCimdPoliciesAPI.md#updatecimdpolicy) | **Put** /oauth/cimd/policies/{id} | Update a CIMD policy.
*OauthCimdSettingsAPI* | [**GetCimdSettings**](docs/OauthCimdSettingsAPI.md#getcimdsettings) | **Get** /oauth/cimd/settings | Get the global CIMD settings.
*OauthCimdSettingsAPI* | [**UpdateCimdSettings**](docs/OauthCimdSettingsAPI.md#updatecimdsettings) | **Put** /oauth/cimd/settings | Update the global CIMD settings.
...
*OauthClientsAPI* | [**DeleteClientSecondarySecrets**](docs/OauthClientsAPI.md#deleteclientsecondarysecrets) | **Delete** /oauth/clients/{id}/clientAuth/clientSecret/secondarySecrets | Revoke all secondary secrets of an existing OAuth client.
...
*OauthJwtBearerGrantProcessorsAPI* | [**CreateJwtBearerGrantProcessor**](docs/OauthJwtBearerGrantProcessorsAPI.md#createjwtbearergrantprocessor) | **Post** /oauth/jwtBearerGrantProcessors | Create a JWT Bearer Grant Processor plugin instance.
*OauthJwtBearerGrantProcessorsAPI* | [**DeleteJwtBearerGrantProcessor**](docs/OauthJwtBearerGrantProcessorsAPI.md#deletejwtbearergrantprocessor) | **Delete** /oauth/jwtBearerGrantProcessors/{id} | Delete a JWT Bearer Grant Processor plugin instance.
*OauthJwtBearerGrantProcessorsAPI* | [**GetJwtBearerGrantProcessor**](docs/OauthJwtBearerGrantProcessorsAPI.md#getjwtbearergrantprocessor) | **Get** /oauth/jwtBearerGrantProcessors/{id} | Get a specific JWT Bearer Grant Processor plugin instance.
*OauthJwtBearerGrantProcessorsAPI* | [**GetJwtBearerGrantProcessorDescriptor**](docs/OauthJwtBearerGrantProcessorsAPI.md#getjwtbearergrantprocessordescriptor) | **Get** /oauth/jwtBearerGrantProcessors/descriptors/{id} | Get a JWT Bearer Grant Processor plugin descriptor.
*OauthJwtBearerGrantProcessorsAPI* | [**GetJwtBearerGrantProcessorDescriptors**](docs/OauthJwtBearerGrantProcessorsAPI.md#getjwtbearergrantprocessordescriptors) | **Get** /oauth/jwtBearerGrantProcessors/descriptors | Get a list of available JWT Bearer Grant Processor plugin descriptors.
*OauthJwtBearerGrantProcessorsAPI* | [**GetJwtBearerGrantProcessors**](docs/OauthJwtBearerGrantProcessorsAPI.md#getjwtbearergrantprocessors) | **Get** /oauth/jwtBearerGrantProcessors | Get a list of JWT Bearer Grant Processor plugin instances.
*OauthJwtBearerGrantProcessorsAPI* | [**UpdateJwtBearerGrantProcessor**](docs/OauthJwtBearerGrantProcessorsAPI.md#updatejwtbearergrantprocessor) | **Put** /oauth/jwtBearerGrantProcessors/{id} | Update a JWT Bearer Grant Processor plugin instance.
...
*ProtocolMetadataAPI* | [**GetAttributeRequesterMappings**](docs/ProtocolMetadataAPI.md#getattributerequestermappings) | **Get** /protocolMetadata/attributeRequesterMappings | Get the attribute requester mappings.
...
*ProtocolMetadataAPI* | [**UpdateAttributeRequesterMappings**](docs/ProtocolMetadataAPI.md#updateattributerequestermappings) | **Put** /protocolMetadata/attributeRequesterMappings | Update the attribute requester mappings.
...
*ServerSettingsAPI* | [**CreateTag**](docs/ServerSettingsAPI.md#createtag) | **Post** /serverSettings/tags | Create a new tag.
...
*ServerSettingsAPI* | [**DeleteTag**](docs/ServerSettingsAPI.md#deletetag) | **Delete** /serverSettings/tags/{id} | Delete a tag.
*ServerSettingsAPI* | [**GetAuditLogSettings**](docs/ServerSettingsAPI.md#getauditlogsettings) | **Get** /serverSettings/auditLogSettings | Gets the audit log settings
...
*ServerSettingsAPI* | [**GetTagById**](docs/ServerSettingsAPI.md#gettagbyid) | **Get** /serverSettings/tags/{id} | Get a tag.
*ServerSettingsAPI* | [**GetTagUsage**](docs/ServerSettingsAPI.md#gettagusage) | **Get** /serverSettings/tags/{id}/usage | Get usage information for a tag.
*ServerSettingsAPI* | [**GetTags**](docs/ServerSettingsAPI.md#gettags) | **Get** /serverSettings/tags | Get the list of tags.
...
*ServerSettingsAPI* | [**UpdateAuditLogSettings**](docs/ServerSettingsAPI.md#updateauditlogsettings) | **Put** /serverSettings/auditLogSettings | Update the audit logging settings.
...
*ServerSettingsAPI* | [**UpdateTag**](docs/ServerSettingsAPI.md#updatetag) | **Put** /serverSettings/tags/{id} | Update a tag.
...
*SessionAPI* | [**GetSessionQuotaSettings**](docs/SessionAPI.md#getsessionquotasettings) | **Get** /session/quotas | Get the session quota settings.
...
*SessionAPI* | [**UpdateSessionQuotaSettings**](docs/SessionAPI.md#updatesessionquotasettings) | **Put** /session/quotas | Update the session quota settings.
...
## Documentation For Models
 ...
 - [AbstractIssuanceCriteriaEntry](docs/AbstractIssuanceCriteriaEntry.md)
 ...
 - [AdminConsoleInfo](docs/AdminConsoleInfo.md)
 - [AdminNodeRoleServiceInfo](docs/AdminNodeRoleServiceInfo.md)
 - [AdministrativeAccount](docs/AdministrativeAccount.md)
 - [AdministrativeAccounts](docs/AdministrativeAccounts.md)
 - [AdministrativeApiCorsSettings](docs/AdministrativeApiCorsSettings.md)
 ...
 - [BaseBrowserSso](docs/BaseBrowserSso.md)
 ...
 - [BulkheadAlertNotificationSettings](docs/BulkheadAlertNotificationSettings.md)
 - [CSRResponse](docs/CSRResponse.md)
 - [CaptchaProvider](docs/CaptchaProvider.md)
 - [CaptchaProviderDescriptor](docs/CaptchaProviderDescriptor.md)
 - [CaptchaProviderDescriptors](docs/CaptchaProviderDescriptors.md)
 ...
 - [CertificateAuth](docs/CertificateAuth.md)
 ...
 - [CimdPolicies](docs/CimdPolicies.md)
 - [CimdPolicy](docs/CimdPolicy.md)
 - [CimdSettings](docs/CimdSettings.md)
 ...
 - [ClientSecretAuth](docs/ClientSecretAuth.md)
 - [ClientSecretJwtAuth](docs/ClientSecretJwtAuth.md)
 ...
 - [DataStoreRepositoryAggregation](docs/DataStoreRepositoryAggregation.md)
 ...
 - [DistinguishedNameToIdpMap](docs/DistinguishedNameToIdpMap.md)
 - [DonePolicyAction](docs/DonePolicyAction.md)
 - [DpopProofSettings](docs/DpopProofSettings.md)
 ...
 - [IdpJwtBearerGrantProcessor](docs/IdpJwtBearerGrantProcessor.md)
 ...
 - [InboundProvisioningUserRepositoryAggregation](docs/InboundProvisioningUserRepositoryAggregation.md)
 ...
 - [JwtBearerGrantProcessor](docs/JwtBearerGrantProcessor.md)
 - [JwtBearerGrantProcessorInstances](docs/JwtBearerGrantProcessorInstances.md)
 ...
 - [KeyPairLink](docs/KeyPairLink.md)
 ...
 - [MetadataAttributeRequesterMapping](docs/MetadataAttributeRequesterMapping.md)
 ...
 - [OAuthOidcKeysSettingsCertificateInformation](docs/OAuthOidcKeysSettingsCertificateInformation.md)
 ...
 - [PrivateKeyJwtAuth](docs/PrivateKeyJwtAuth.md)
 ...
 - [RedirectValidationSettingsUriAllowlistEntry](docs/RedirectValidationSettingsUriAllowlistEntry.md)
 ...
 - [Scim2Schema](docs/Scim2Schema.md)
 - [Scim2SchemaAttribute](docs/Scim2SchemaAttribute.md)
 - [Scim2SchemaSubAttribute](docs/Scim2SchemaSubAttribute.md)
 - [ScopeEntries](docs/ScopeEntries.md)
 - [ScopeEntry](docs/ScopeEntry.md)
 - [ScopeGroupEntries](docs/ScopeGroupEntries.md)
 ...
 - [SessionQuotaSettings](docs/SessionQuotaSettings.md)
 ...
 - [SpOAuthProcessorPolicyMapping](docs/SpOAuthProcessorPolicyMapping.md)
 - [SpOAuthTokenExchangeAttributeContract](docs/SpOAuthTokenExchangeAttributeContract.md)
 - [SpOAuthTokenExchangeSettings](docs/SpOAuthTokenExchangeSettings.md)
...
- **Type**: OAuth
- **Flow**: application
- **Authorization URL**: https://localhost:9031/as/authorization.oauth2
- **Scopes**: N/A
