...
type EncryptionPolicy struct {
	...
	EncryptAttributeList []string `json:"encryptAttributeList,omitempty" tfsdk:"encrypt_attribute_list"`
}
...
// GetEncryptAttributeList returns the EncryptAttributeList field value if set, zero value otherwise.
func (o *EncryptionPolicy) GetEncryptAttributeList() []string {
	if o == nil || IsNil(o.EncryptAttributeList) {
		var ret []string
		return ret
	}
	return o.EncryptAttributeList
}

// GetEncryptAttributeListOk returns a tuple with the EncryptAttributeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EncryptionPolicy) GetEncryptAttributeListOk() ([]string, bool) {
	if o == nil || IsNil(o.EncryptAttributeList) {
		return nil, false
	}
	return o.EncryptAttributeList, true
}
...
// SetEncryptAttributeList gets a reference to the given []string and assigns it to the EncryptAttributeList field.
func (o *EncryptionPolicy) SetEncryptAttributeList(v []string) {
	o.EncryptAttributeList = v
}
...
func (o EncryptionPolicy) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EncryptAttributeList) {
		toSerialize["encryptAttributeList"] = o.EncryptAttributeList
	}
