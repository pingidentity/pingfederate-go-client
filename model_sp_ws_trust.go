...
type SpWsTrust struct {
	...
	PartnerServiceIds []string `json:"partnerServiceIds"`
	...
	MinutesBefore *int64 `json:"minutesBefore,omitempty"`
	// The amount of time after the SAML token was issued during which it is to be considered valid. The default value is 30.
	MinutesAfter      *int64                     `json:"minutesAfter,omitempty"`
	AttributeContract SpWsTrustAttributeContract `json:"attributeContract"`
	// A list of token processors to validate incoming tokens.
	TokenProcessorMappings []IdpTokenProcessorMapping `json:"tokenProcessorMappings"`
