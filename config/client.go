...
// NewAPIClientWithTokenSource builds a ready-to-use configurationapi.APIClient for the PingFederate
...
func (c *Configuration) NewAPIClientWithTokenSource(ctx context.Context, adminAPIURL string, httpClient *http.Client) (*configurationapi.APIClient, error) {
