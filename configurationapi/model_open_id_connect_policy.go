...
// GetAllowIdTokenIntrospection returns the AllowIdTokenIntrospection field value if set, zero value otherwise.
func (o *OpenIdConnectPolicy) GetAllowIdTokenIntrospection() bool {
	if o == nil || IsNil(o.AllowIdTokenIntrospection) {
		var ret bool
		return ret
	}
	return *o.AllowIdTokenIntrospection
}

// GetAllowIdTokenIntrospectionOk returns a tuple with the AllowIdTokenIntrospection field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OpenIdConnectPolicy) GetAllowIdTokenIntrospectionOk() (*bool, bool) {
	if o == nil || IsNil(o.AllowIdTokenIntrospection) {
		return nil, false
	}
	return o.AllowIdTokenIntrospection, true
}
...
// SetAllowIdTokenIntrospection gets a reference to the given bool and assigns it to the AllowIdTokenIntrospection field.
