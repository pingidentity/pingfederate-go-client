...
type DynamicClientRegistration struct {
	...
	AllowedAuthorizationDetailTypes []string `json:"allowedAuthorizationDetailTypes,omitempty"`
	...
	RetainClientSecret *bool `json:"retainClientSecret,omitempty"`
	...
	ClientSecretRetentionPeriodOverride *int64 `json:"clientSecretRetentionPeriodOverride,omitempty"`
