...
type _BaseSigningSettings BaseSigningSettings
...
func (o *BaseSigningSettings) UnmarshalJSON(bytes []byte) (err error) {
	...
	varBaseSigningSettings := _BaseSigningSettings{}

	err = json.Unmarshal(bytes, &varBaseSigningSettings)

	if err != nil {
		return err
	}

	*o = BaseSigningSettings(varBaseSigningSettings)
