...
type _SpAttributeQuery SpAttributeQuery
...
func (o *SpAttributeQuery) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSpAttributeQuery := _SpAttributeQuery{}

	err = json.Unmarshal(bytes, &varSpAttributeQuery)

	if err != nil {
		return err
	}

	*o = SpAttributeQuery(varSpAttributeQuery)
