...
func (o *IdentityStoreInboundProvisioningUserRepository) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varIdentityStoreInboundProvisioningUserRepository)
