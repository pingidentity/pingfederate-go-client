...
`func NewDataStoreRepositoryAggregation(jitRepositoryAttributeMapping map[string]AttributeFulfillmentValue, dataStoreRef ResourceLink, type_ string, uniqueUserIdFilter string, ) *DataStoreRepositoryAggregation`
