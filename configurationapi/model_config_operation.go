...
type ConfigOperation struct {
	...
	// The type of operation to be performed. Currently, the DELETE operation is only supported for the /configStore resource type.
	...
	// The subresource for the operation. Currently, the only resource type that supports subresources is /configStore.
