...
func (o *IssuerCert) UnmarshalJSON(bytes []byte) (err error) {
	...
	varIssuerCert := _IssuerCert{}

	err = json.Unmarshal(bytes, &varIssuerCert)

	if err != nil {
		return err
	}

	*o = IssuerCert(varIssuerCert)
