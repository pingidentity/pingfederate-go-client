...
type _TokenGeneratorAttribute TokenGeneratorAttribute
...
func (o *TokenGeneratorAttribute) UnmarshalJSON(bytes []byte) (err error) {
	...
	varTokenGeneratorAttribute := _TokenGeneratorAttribute{}

	err = json.Unmarshal(bytes, &varTokenGeneratorAttribute)

	if err != nil {
		return err
	}

	*o = TokenGeneratorAttribute(varTokenGeneratorAttribute)
