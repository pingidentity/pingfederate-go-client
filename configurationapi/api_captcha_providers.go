...
func (r ApiGetCaptchaProviderPluginDescriptorRequest) Execute() (*CaptchaProviderDescriptor, *http.Response, error) {
...
// Execute executes the request
//
//	@return CaptchaProviderDescriptor
func (a *CaptchaProvidersAPIService) GetCaptchaProviderPluginDescriptorExecute(r ApiGetCaptchaProviderPluginDescriptorRequest) (*CaptchaProviderDescriptor, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *CaptchaProviderDescriptor
	)
...
func (a *CaptchaProvidersAPIService) internalGetCaptchaProviderPluginDescriptorExecute(r ApiGetCaptchaProviderPluginDescriptorRequest) (*CaptchaProviderDescriptor, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
