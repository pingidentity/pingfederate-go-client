...
type NotificationSettings struct {
	...
	LicenseEventSettings                               *LicenseEventNotificationSettings         `json:"licenseEventSettings,omitempty" tfsdk:"license_event_settings"`
}
...
// GetLicenseEventSettings returns the LicenseEventSettings field value if set, zero value otherwise.
func (o *NotificationSettings) GetLicenseEventSettings() LicenseEventNotificationSettings {
	if o == nil || IsNil(o.LicenseEventSettings) {
		var ret LicenseEventNotificationSettings
		return ret
	}
	return *o.LicenseEventSettings
}

// GetLicenseEventSettingsOk returns a tuple with the LicenseEventSettings field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NotificationSettings) GetLicenseEventSettingsOk() (*LicenseEventNotificationSettings, bool) {
	if o == nil || IsNil(o.LicenseEventSettings) {
		return nil, false
	}
	return o.LicenseEventSettings, true
}
...
// SetLicenseEventSettings gets a reference to the given LicenseEventNotificationSettings and assigns it to the LicenseEventSettings field.
func (o *NotificationSettings) SetLicenseEventSettings(v LicenseEventNotificationSettings) {
	o.LicenseEventSettings = &v
}
...
func (o NotificationSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LicenseEventSettings) {
		toSerialize["licenseEventSettings"] = o.LicenseEventSettings
	}
