...
// checks if the RequestPolicies type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestPolicies{}
...
type NullableRequestPolicies struct {
	value *RequestPolicies
	isSet bool
}

func (v NullableRequestPolicies) Get() *RequestPolicies {
	return v.value
}

func (v *NullableRequestPolicies) Set(val *RequestPolicies) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRequestPolicies(val *RequestPolicies) *NullableRequestPolicies {
	return &NullableRequestPolicies{value: val, isSet: true}
}
