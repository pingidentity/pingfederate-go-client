...
type ClusterSettings struct {
	...
	// Whether changes to Log Settings will automatically be replicated to the cluster.
	ReplicateLogSettingsOnSave *bool `json:"replicateLogSettingsOnSave,omitempty" tfsdk:"replicate_log_settings_on_save"`
}
...
// GetReplicateLogSettingsOnSave returns the ReplicateLogSettingsOnSave field value if set, zero value otherwise.
func (o *ClusterSettings) GetReplicateLogSettingsOnSave() bool {
	if o == nil || IsNil(o.ReplicateLogSettingsOnSave) {
		var ret bool
		return ret
	}
	return *o.ReplicateLogSettingsOnSave
}

// GetReplicateLogSettingsOnSaveOk returns a tuple with the ReplicateLogSettingsOnSave field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterSettings) GetReplicateLogSettingsOnSaveOk() (*bool, bool) {
	if o == nil || IsNil(o.ReplicateLogSettingsOnSave) {
		return nil, false
	}
	return o.ReplicateLogSettingsOnSave, true
}
...
// SetReplicateLogSettingsOnSave gets a reference to the given bool and assigns it to the ReplicateLogSettingsOnSave field.
func (o *ClusterSettings) SetReplicateLogSettingsOnSave(v bool) {
	o.ReplicateLogSettingsOnSave = &v
}
...
func (o ClusterSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ReplicateLogSettingsOnSave) {
		toSerialize["replicateLogSettingsOnSave"] = o.ReplicateLogSettingsOnSave
	}
