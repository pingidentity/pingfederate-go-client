...
func (o *ReadUsers) UnmarshalJSON(bytes []byte) (err error) {
	...
	varReadUsers := _ReadUsers{}

	err = json.Unmarshal(bytes, &varReadUsers)

	if err != nil {
		return err
	}

	*o = ReadUsers(varReadUsers)
