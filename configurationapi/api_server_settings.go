...
Create a tag. If the tag is not properly configured, a 422 status code is returned along with a list of validation errors that must be corrected.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCreateTagRequest
*/
func (a *ServerSettingsAPIService) CreateTag(ctx context.Context) ApiCreateTagRequest {
	return ApiCreateTagRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return Tag
func (a *ServerSettingsAPIService) CreateTagExecute(r ApiCreateTagRequest) (*Tag, *http.Response, error) {
	var (
		err                 error
	...
	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalCreateTagExecute(r)
		},
		&localVarReturnValue,
	)
...
func (a *ServerSettingsAPIService) internalCreateTagExecute(r ApiCreateTagRequest) (*Tag, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerSettingsAPIService.CreateTag")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/serverSettings/tags"
...
Delete a tag with the specified ID. A 404 status code is returned for nonexistent IDs. Returns 422 if any authentication selector instance, OAuth client settings, or CIMD policies reference the tag — these references must be removed manually before the tag can be deleted. OAuth clients that previously referenced the deleted tag will no longer show it in API responses. Note: If the request succeeds, the response body is empty.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id ID of the tag.
	@return ApiDeleteTagRequest
*/
func (a *ServerSettingsAPIService) DeleteTag(ctx context.Context, id string) ApiDeleteTagRequest {
	return ApiDeleteTagRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *ServerSettingsAPIService) DeleteTagExecute(r ApiDeleteTagRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerSettingsAPIService.DeleteTag")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/serverSettings/tags/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiGetAuditLogSettingsRequest struct {
	ctx        context.Context
	ApiService *ServerSettingsAPIService
}

func (r ApiGetAuditLogSettingsRequest) Execute() (*AuditLoggingSettings, *http.Response, error) {
	return r.ApiService.GetAuditLogSettingsExecute(r)
}

/*
GetAuditLogSettings Gets the audit log settings

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetAuditLogSettingsRequest
*/
func (a *ServerSettingsAPIService) GetAuditLogSettings(ctx context.Context) ApiGetAuditLogSettingsRequest {
	return ApiGetAuditLogSettingsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ServerSettingsAPIService) GetAuditLogSettingsExecute(r ApiGetAuditLogSettingsRequest) (*AuditLoggingSettings, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *AuditLoggingSettings
	)

	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalGetAuditLogSettingsExecute(r)
		},
		&localVarReturnValue,
	)
	return localVarReturnValue, response, err
...
func (a *ServerSettingsAPIService) internalGetAuditLogSettingsExecute(r ApiGetAuditLogSettingsRequest) (*AuditLoggingSettings, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerSettingsAPIService.GetAuditLogSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/serverSettings/auditLogSettings"
...
/*
GetTagById Get a tag.

Get the configured tag with the specified ID. A 404 status code is returned for nonexistent IDs.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id ID of the tag.
	@return ApiGetTagByIdRequest
*/
func (a *ServerSettingsAPIService) GetTagById(ctx context.Context, id string) ApiGetTagByIdRequest {
	return ApiGetTagByIdRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return Tag
func (a *ServerSettingsAPIService) GetTagByIdExecute(r ApiGetTagByIdRequest) (*Tag, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *Tag
	...
	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalGetTagByIdExecute(r)
		},
		&localVarReturnValue,
	)
	return localVarReturnValue, response, err
...
func (a *ServerSettingsAPIService) internalGetTagByIdExecute(r ApiGetTagByIdRequest) (*Tag, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerSettingsAPIService.GetTagById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetTagUsageRequest struct {
	ctx        context.Context
	ApiService *ServerSettingsAPIService
	id         string
}

func (r ApiGetTagUsageRequest) Execute() (*TagUsage, *http.Response, error) {
	return r.ApiService.GetTagUsageExecute(r)
}

/*
GetTagUsage Get usage information for a tag.

Returns the number of OAuth clients that reference this tag, the authentication selector instances that reference it, the CIMD policies that reference it, and whether OAuth client settings reference it. Use this prior to deletion to surface a confirmation prompt or block delete when authentication selectors, OAuth client settings, or CIMD policies are involved. The clientIds field is only populated for callers that also have the OAUTH_CLIENT READ permission.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id ID of the tag.
	@return ApiGetTagUsageRequest
*/
func (a *ServerSettingsAPIService) GetTagUsage(ctx context.Context, id string) ApiGetTagUsageRequest {
	return ApiGetTagUsageRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return TagUsage
func (a *ServerSettingsAPIService) GetTagUsageExecute(r ApiGetTagUsageRequest) (*TagUsage, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *TagUsage
	)

	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalGetTagUsageExecute(r)
		},
		&localVarReturnValue,
	)
	return localVarReturnValue, response, err
...
func (a *ServerSettingsAPIService) internalGetTagUsageExecute(r ApiGetTagUsageRequest) (*TagUsage, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerSettingsAPIService.GetTagUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/serverSettings/tags/{id}/usage"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
// Number of tags per page. (uncapped if unspecified)
func (r ApiGetTagsRequest) NumberPerPage(numberPerPage int64) ApiGetTagsRequest {
	r.numberPerPage = &numberPerPage
	return r
}

// Filter criteria limits the tags that are returned to only those that match it. The filter criteria is compared to the tag name and ID fields. The comparison is a case-insensitive prefix match. No additional pattern based matching is supported.
...
/*
GetTags Get the list of tags.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetTagsRequest
*/
func (a *ServerSettingsAPIService) GetTags(ctx context.Context) ApiGetTagsRequest {
	return ApiGetTagsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return Tags
func (a *ServerSettingsAPIService) GetTagsExecute(r ApiGetTagsRequest) (*Tags, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
	...
	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalGetTagsExecute(r)
		},
		&localVarReturnValue,
	)
	return localVarReturnValue, response, err
...
func (a *ServerSettingsAPIService) internalGetTagsExecute(r ApiGetTagsRequest) (*Tags, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerSettingsAPIService.GetTags")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateAuditLogSettingsRequest struct {
	ctx        context.Context
	ApiService *ServerSettingsAPIService
	body       *AuditLoggingSettings
}

// Configuration for audit log settings.
func (r ApiUpdateAuditLogSettingsRequest) Body(body AuditLoggingSettings) ApiUpdateAuditLogSettingsRequest {
	r.body = &body
	return r
}

func (r ApiUpdateAuditLogSettingsRequest) Execute() (*AuditLoggingSettings, *http.Response, error) {
	return r.ApiService.UpdateAuditLogSettingsExecute(r)
}

/*
UpdateAuditLogSettings Update the audit logging settings.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiUpdateAuditLogSettingsRequest
*/
func (a *ServerSettingsAPIService) UpdateAuditLogSettings(ctx context.Context) ApiUpdateAuditLogSettingsRequest {
	return ApiUpdateAuditLogSettingsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return AuditLoggingSettings
func (a *ServerSettingsAPIService) UpdateAuditLogSettingsExecute(r ApiUpdateAuditLogSettingsRequest) (*AuditLoggingSettings, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *AuditLoggingSettings
	...
	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalUpdateAuditLogSettingsExecute(r)
		},
		&localVarReturnValue,
	)
	return localVarReturnValue, response, err
...
func (a *ServerSettingsAPIService) internalUpdateAuditLogSettingsExecute(r ApiUpdateAuditLogSettingsRequest) (*AuditLoggingSettings, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerSettingsAPIService.UpdateAuditLogSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Update a tag with matching ID. If the tag is not properly configured, a 422 status code is returned along with a list of validation errors that must be corrected. A 404 status code is returned for nonexistent IDs.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id ID of the tag.
	@return ApiUpdateTagRequest
*/
func (a *ServerSettingsAPIService) UpdateTag(ctx context.Context, id string) ApiUpdateTagRequest {
	return ApiUpdateTagRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return Tag
func (a *ServerSettingsAPIService) UpdateTagExecute(r ApiUpdateTagRequest) (*Tag, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *Tag
...
func (a *ServerSettingsAPIService) internalUpdateTagExecute(r ApiUpdateTagRequest) (*Tag, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServerSettingsAPIService.UpdateTag")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
