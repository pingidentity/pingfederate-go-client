...
type _PasswordCredentialValidator PasswordCredentialValidator
...
func (o *PasswordCredentialValidator) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPasswordCredentialValidator := _PasswordCredentialValidator{}

	err = json.Unmarshal(bytes, &varPasswordCredentialValidator)

	if err != nil {
		return err
	}

	*o = PasswordCredentialValidator(varPasswordCredentialValidator)
