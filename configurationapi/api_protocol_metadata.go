...
type ApiGetAttributeRequesterMappingsRequest struct {
	ctx        context.Context
	ApiService *ProtocolMetadataAPIService
}

func (r ApiGetAttributeRequesterMappingsRequest) Execute() (*MetadataAttributeRequesterMapping, *http.Response, error) {
	return r.ApiService.GetAttributeRequesterMappingsExecute(r)
}

/*
GetAttributeRequesterMappings Get the attribute requester mappings.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetAttributeRequesterMappingsRequest
*/
func (a *ProtocolMetadataAPIService) GetAttributeRequesterMappings(ctx context.Context) ApiGetAttributeRequesterMappingsRequest {
	return ApiGetAttributeRequesterMappingsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return MetadataAttributeRequesterMapping
func (a *ProtocolMetadataAPIService) GetAttributeRequesterMappingsExecute(r ApiGetAttributeRequesterMappingsRequest) (*MetadataAttributeRequesterMapping, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *MetadataAttributeRequesterMapping
	)

	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalGetAttributeRequesterMappingsExecute(r)
		},
		&localVarReturnValue,
	)
...
func (a *ProtocolMetadataAPIService) internalGetAttributeRequesterMappingsExecute(r ApiGetAttributeRequesterMappingsRequest) (*MetadataAttributeRequesterMapping, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProtocolMetadataAPIService.GetAttributeRequesterMappings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/protocolMetadata/attributeRequesterMappings"
...
type ApiUpdateAttributeRequesterMappingsRequest struct {
	ctx        context.Context
	ApiService *ProtocolMetadataAPIService
	body       *MetadataAttributeRequesterMapping
}

func (r ApiUpdateAttributeRequesterMappingsRequest) Body(body MetadataAttributeRequesterMapping) ApiUpdateAttributeRequesterMappingsRequest {
	r.body = &body
	return r
}

func (r ApiUpdateAttributeRequesterMappingsRequest) Execute() (*MetadataAttributeRequesterMapping, *http.Response, error) {
	return r.ApiService.UpdateAttributeRequesterMappingsExecute(r)
}

/*
UpdateAttributeRequesterMappings Update the attribute requester mappings.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiUpdateAttributeRequesterMappingsRequest
*/
func (a *ProtocolMetadataAPIService) UpdateAttributeRequesterMappings(ctx context.Context) ApiUpdateAttributeRequesterMappingsRequest {
	return ApiUpdateAttributeRequesterMappingsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return MetadataAttributeRequesterMapping
func (a *ProtocolMetadataAPIService) UpdateAttributeRequesterMappingsExecute(r ApiUpdateAttributeRequesterMappingsRequest) (*MetadataAttributeRequesterMapping, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *MetadataAttributeRequesterMapping
	...
	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalUpdateAttributeRequesterMappingsExecute(r)
		},
		&localVarReturnValue,
	)
	return localVarReturnValue, response, err
...
func (a *ProtocolMetadataAPIService) internalUpdateAttributeRequesterMappingsExecute(r ApiUpdateAttributeRequesterMappingsRequest) (*MetadataAttributeRequesterMapping, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProtocolMetadataAPIService.UpdateAttributeRequesterMappings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
