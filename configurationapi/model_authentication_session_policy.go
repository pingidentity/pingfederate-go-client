...
type AuthenticationSessionPolicy struct {
	// The persistent, unique ID for the session policy. It can be any combination of [a-zA-Z0-9._-]. This property is system-assigned if not specified.
...
func (o *AuthenticationSessionPolicy) GetUserDeviceType() string {
	if o == nil || IsNil(o.UserDeviceType) {
		var ret string
		return ret
	}
	return *o.UserDeviceType
}

// GetUserDeviceTypeOk returns a tuple with the UserDeviceType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuthenticationSessionPolicy) GetUserDeviceTypeOk() (*string, bool) {
	if o == nil || IsNil(o.UserDeviceType) {
		return nil, false
	}
	return o.UserDeviceType, true
}
...
func (o AuthenticationSessionPolicy) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UserDeviceType) {
		toSerialize["userDeviceType"] = o.UserDeviceType
	}
