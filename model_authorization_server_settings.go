...
type AuthorizationServerSettings struct {
	...
	DefaultScopeDescription string `json:"defaultScopeDescription"`
	...
	AuthorizationCodeTimeout int64 `json:"authorizationCodeTimeout"`
	// The authorization code entropy, in bytes.
	AuthorizationCodeEntropy int64 `json:"authorizationCodeEntropy"`
	...
	PersistentGrantLifetime *int64 `json:"persistentGrantLifetime,omitempty"`
	...
	RefreshTokenLength int64 `json:"refreshTokenLength"`
	...
	RefreshRollingInterval int64 `json:"refreshRollingInterval"`
	...
	RegisteredAuthorizationPath string `json:"registeredAuthorizationPath"`
	// The 'device_code' and 'user_code' timeout, in seconds.
	PendingAuthorizationTimeout int64 `json:"pendingAuthorizationTimeout"`
	// The amount of time client should wait between polling requests, in seconds.
	DevicePollingInterval int64 `json:"devicePollingInterval"`
	...
	ActivationCodeCheckMode *string `json:"activationCodeCheckMode,omitempty"`
	...
	BypassActivationCodeConfirmation bool `json:"bypassActivationCodeConfirmation"`
	...
	ApprovedAuthorizationDetailAttribute *string `json:"approvedAuthorizationDetailAttribute,omitempty"`
	// The timeout, in seconds, of the pushed authorization request reference. The default value is 60.
	ParReferenceTimeout *int64 `json:"parReferenceTimeout,omitempty"`
	// The entropy of pushed authorization request references, in bytes. The default value is 24.
	ParReferenceLength *int64 `json:"parReferenceLength,omitempty"`
	...
	JwtSecuredAuthorizationResponseModeLifetime *int64 `json:"jwtSecuredAuthorizationResponseModeLifetime,omitempty"`
}
