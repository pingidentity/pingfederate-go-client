...
// checks if the OpenIdConnectPolicies type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenIdConnectPolicies{}
...
type NullableOpenIdConnectPolicies struct {
	value *OpenIdConnectPolicies
	isSet bool
}

func (v NullableOpenIdConnectPolicies) Get() *OpenIdConnectPolicies {
	return v.value
}

func (v *NullableOpenIdConnectPolicies) Set(val *OpenIdConnectPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenIdConnectPolicies) IsSet() bool {
	return v.isSet
}
...
func NewNullableOpenIdConnectPolicies(val *OpenIdConnectPolicies) *NullableOpenIdConnectPolicies {
	return &NullableOpenIdConnectPolicies{value: val, isSet: true}
}
