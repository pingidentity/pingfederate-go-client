...
type _LdapDataStoreAttribute LdapDataStoreAttribute
...
func (o *LdapDataStoreAttribute) UnmarshalJSON(bytes []byte) (err error) {
	...
	varLdapDataStoreAttribute := _LdapDataStoreAttribute{}

	err = json.Unmarshal(bytes, &varLdapDataStoreAttribute)

	if err != nil {
		return err
	}

	*o = LdapDataStoreAttribute(varLdapDataStoreAttribute)
