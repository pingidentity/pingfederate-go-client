...
`func (o *IdpAdapterContractMapping) GetAttributeSource() []AttributeSourceAggregation`

GetAttributeSource returns the AttributeSource field if non-nil, zero value otherwise.

### GetAttributeSourceOk

`func (o *IdpAdapterContractMapping) GetAttributeSourceOk() (*[]AttributeSourceAggregation, bool)`
...
`func (o *IdpAdapterContractMapping) SetAttributeSource(v []AttributeSourceAggregation)`

SetAttributeSource sets AttributeSource field to given value.

### HasAttributeSource

`func (o *IdpAdapterContractMapping) HasAttributeSource() bool`
