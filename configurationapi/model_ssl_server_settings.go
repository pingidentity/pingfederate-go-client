...
type SslServerSettings struct {
	...
	ActiveRuntimeServerCerts []ResourceLink `json:"activeRuntimeServerCerts" tfsdk:"active_runtime_server_certs"`
	// The active SSL Server Certificate Key pairs for PF Administrator Console.
	ActiveAdminConsoleCerts []ResourceLink `json:"activeAdminConsoleCerts" tfsdk:"active_admin_console_certs"`
}
...
func NewSslServerSettings(runtimeServerCertRef ResourceLink, adminConsoleCertRef ResourceLink, activeRuntimeServerCerts []ResourceLink, activeAdminConsoleCerts []ResourceLink) *SslServerSettings {
	...
	this.ActiveRuntimeServerCerts = activeRuntimeServerCerts
	this.ActiveAdminConsoleCerts = activeAdminConsoleCerts
	return &this
}
...
// GetActiveRuntimeServerCerts returns the ActiveRuntimeServerCerts field value
...
// GetActiveRuntimeServerCertsOk returns a tuple with the ActiveRuntimeServerCerts field value
// and a boolean to check if the value has been set.
...
// SetActiveRuntimeServerCerts sets field value
func (o *SslServerSettings) SetActiveRuntimeServerCerts(v []ResourceLink) {
	o.ActiveRuntimeServerCerts = v
}

// GetActiveAdminConsoleCerts returns the ActiveAdminConsoleCerts field value
...
// GetActiveAdminConsoleCertsOk returns a tuple with the ActiveAdminConsoleCerts field value
// and a boolean to check if the value has been set.
...
// SetActiveAdminConsoleCerts sets field value
