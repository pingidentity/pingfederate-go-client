...
type _ClientRegistrationPolicy ClientRegistrationPolicy
...
func (o *ClientRegistrationPolicy) UnmarshalJSON(bytes []byte) (err error) {
	...
	varClientRegistrationPolicy := _ClientRegistrationPolicy{}

	err = json.Unmarshal(bytes, &varClientRegistrationPolicy)

	if err != nil {
		return err
	}

	*o = ClientRegistrationPolicy(varClientRegistrationPolicy)
