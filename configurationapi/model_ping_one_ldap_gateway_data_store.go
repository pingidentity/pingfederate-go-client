...
type PingOneLdapGatewayDataStore struct {
	...
	// Connects to the LDAP data store using StartTLS. The default value is false. The value is validated against the LDAP gateway configuration in PingOne unless the header 'X-BypassExternalValidation' is set to true.
	UseStartTLS *bool `json:"useStartTLS,omitempty" tfsdk:"use_start_tls"`
}
