...
type _OutOfBandAuthAttribute OutOfBandAuthAttribute
...
func (o *OutOfBandAuthAttribute) UnmarshalJSON(bytes []byte) (err error) {
	...
	varOutOfBandAuthAttribute := _OutOfBandAuthAttribute{}

	err = json.Unmarshal(bytes, &varOutOfBandAuthAttribute)

	if err != nil {
		return err
	}

	*o = OutOfBandAuthAttribute(varOutOfBandAuthAttribute)
