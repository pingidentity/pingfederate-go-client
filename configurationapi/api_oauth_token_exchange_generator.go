...
func (r ApiCreateGroupRequest) XBypassExternalValidation(xBypassExternalValidation bool) ApiCreateGroupRequest {
...
// External validation will be bypassed when set to true. Default to false.
func (r ApiUpdateOauthTokenExchangeGroupRequest) XBypassExternalValidation(xBypassExternalValidation bool) ApiUpdateOauthTokenExchangeGroupRequest {
	r.xBypassExternalValidation = &xBypassExternalValidation
	return r
}
...
// External validation will be bypassed when set to true. Default to false.
func (r ApiUpdateOauthTokenExchangeSettingsRequest) XBypassExternalValidation(xBypassExternalValidation bool) ApiUpdateOauthTokenExchangeSettingsRequest {
	r.xBypassExternalValidation = &xBypassExternalValidation
	return r
}
