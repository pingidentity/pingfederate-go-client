...
`func (o *AuthenticationPolicyContractMapping) GetAttributeSource() []AttributeSourceAggregation`

GetAttributeSource returns the AttributeSource field if non-nil, zero value otherwise.

### GetAttributeSourceOk

`func (o *AuthenticationPolicyContractMapping) GetAttributeSourceOk() (*[]AttributeSourceAggregation, bool)`
...
`func (o *AuthenticationPolicyContractMapping) SetAttributeSource(v []AttributeSourceAggregation)`

SetAttributeSource sets AttributeSource field to given value.

### HasAttributeSource

`func (o *AuthenticationPolicyContractMapping) HasAttributeSource() bool`
