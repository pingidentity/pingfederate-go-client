...
type GeneralSettings struct {
	...
	// Boolean that disables automatic plugin validation when set to true. The default is false.
	DisableAutomaticPluginValidation *bool `json:"disableAutomaticPluginValidation,omitempty" tfsdk:"disable_automatic_plugin_validation"`
...
// GetDisableAutomaticPluginValidation returns the DisableAutomaticPluginValidation field value if set, zero value otherwise.
func (o *GeneralSettings) GetDisableAutomaticPluginValidation() bool {
	if o == nil || IsNil(o.DisableAutomaticPluginValidation) {
		var ret bool
		return ret
	}
	return *o.DisableAutomaticPluginValidation
}

// GetDisableAutomaticPluginValidationOk returns a tuple with the DisableAutomaticPluginValidation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GeneralSettings) GetDisableAutomaticPluginValidationOk() (*bool, bool) {
	if o == nil || IsNil(o.DisableAutomaticPluginValidation) {
		return nil, false
	}
	return o.DisableAutomaticPluginValidation, true
}
...
// SetDisableAutomaticPluginValidation gets a reference to the given bool and assigns it to the DisableAutomaticPluginValidation field.
func (o *GeneralSettings) SetDisableAutomaticPluginValidation(v bool) {
	o.DisableAutomaticPluginValidation = &v
}
...
func (o GeneralSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DisableAutomaticPluginValidation) {
		toSerialize["disableAutomaticPluginValidation"] = o.DisableAutomaticPluginValidation
	}
