...
// checks if the CaptchaProviderDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CaptchaProviderDescriptor{}

// CaptchaProviderDescriptor A CAPTCHA provider plugin descriptor.
type CaptchaProviderDescriptor struct {
...
func NewCaptchaProviderDescriptor() *CaptchaProviderDescriptor {
	this := CaptchaProviderDescriptor{}
	return &this
}
...
func (o CaptchaProviderDescriptor) MarshalJSON() ([]byte, error) {
...
func (o CaptchaProviderDescriptor) ToMap() (map[string]interface{}, error) {
...
type NullableCaptchaProviderDescriptor struct {
	value *CaptchaProviderDescriptor
	isSet bool
}

func (v NullableCaptchaProviderDescriptor) Get() *CaptchaProviderDescriptor {
	return v.value
}

func (v *NullableCaptchaProviderDescriptor) Set(val *CaptchaProviderDescriptor) {
	v.value = val
	v.isSet = true
}

func (v NullableCaptchaProviderDescriptor) IsSet() bool {
	return v.isSet
}

func (v *NullableCaptchaProviderDescriptor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCaptchaProviderDescriptor(val *CaptchaProviderDescriptor) *NullableCaptchaProviderDescriptor {
	return &NullableCaptchaProviderDescriptor{value: val, isSet: true}
}

func (v NullableCaptchaProviderDescriptor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCaptchaProviderDescriptor) UnmarshalJSON(src []byte) error {
	v.isSet = true
