...
type OIDCProviderSettings struct {
	...
	// The header `typ`, that goes into the JWT header if specified. This is only used for client secret jwt and private key jwt auth schemes.
	Type *string `json:"type,omitempty" tfsdk:"type"`
	// The lifetime of the JWT in minutes. This is only used for client secret jwt and private key jwt auth schemes.
	Lifetime *string `json:"lifetime,omitempty" tfsdk:"lifetime"`
	// The claim `aud`, that goes into the JWT body if specified. This is only used for client secret jwt and private key jwt auth schemes.
	Audience *string `json:"audience,omitempty" tfsdk:"audience"`
	// Include the claim `nbf` in the JWT body. This is only used for client secret jwt and private key jwt auth schemes.
	IncludeNotBeforeClaim *bool `json:"includeNotBeforeClaim,omitempty" tfsdk:"include_not_before_claim"`
...
// GetJwtSecuredAuthorizationResponseModeType returns the JwtSecuredAuthorizationResponseModeType field value if set, zero value otherwise.
func (o *OIDCProviderSettings) GetJwtSecuredAuthorizationResponseModeType() string {
	if o == nil || IsNil(o.JwtSecuredAuthorizationResponseModeType) {
		var ret string
		return ret
	}
	return *o.JwtSecuredAuthorizationResponseModeType
}

// GetJwtSecuredAuthorizationResponseModeTypeOk returns a tuple with the JwtSecuredAuthorizationResponseModeType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OIDCProviderSettings) GetJwtSecuredAuthorizationResponseModeTypeOk() (*string, bool) {
	if o == nil || IsNil(o.JwtSecuredAuthorizationResponseModeType) {
		return nil, false
	}
	return o.JwtSecuredAuthorizationResponseModeType, true
}
...
// SetJwtSecuredAuthorizationResponseModeType gets a reference to the given string and assigns it to the JwtSecuredAuthorizationResponseModeType field.
func (o *OIDCProviderSettings) SetJwtSecuredAuthorizationResponseModeType(v string) {
	o.JwtSecuredAuthorizationResponseModeType = &v
}
...
// GetIncludeNotBeforeClaim returns the IncludeNotBeforeClaim field value if set, zero value otherwise.
func (o *OIDCProviderSettings) GetIncludeNotBeforeClaim() bool {
	if o == nil || IsNil(o.IncludeNotBeforeClaim) {
		var ret bool
		return ret
	}
	return *o.IncludeNotBeforeClaim
}

// GetIncludeNotBeforeClaimOk returns a tuple with the IncludeNotBeforeClaim field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OIDCProviderSettings) GetIncludeNotBeforeClaimOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeNotBeforeClaim) {
		return nil, false
	}
	return o.IncludeNotBeforeClaim, true
}
...
// SetIncludeNotBeforeClaim gets a reference to the given bool and assigns it to the IncludeNotBeforeClaim field.
func (o *OIDCProviderSettings) SetIncludeNotBeforeClaim(v bool) {
	o.IncludeNotBeforeClaim = &v
}
...
func (o OIDCProviderSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.JwtSecuredAuthorizationResponseModeType) {
		toSerialize["jwtSecuredAuthorizationResponseModeType"] = o.JwtSecuredAuthorizationResponseModeType
	}
	...
	if !IsNil(o.IncludeNotBeforeClaim) {
		toSerialize["includeNotBeforeClaim"] = o.IncludeNotBeforeClaim
	}
