...
type _PluginInstance PluginInstance
...
func (o *PluginInstance) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPluginInstance := _PluginInstance{}

	err = json.Unmarshal(bytes, &varPluginInstance)

	if err != nil {
		return err
	}

	*o = PluginInstance(varPluginInstance)
