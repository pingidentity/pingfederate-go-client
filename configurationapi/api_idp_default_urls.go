...
func (r ApiGetDefaultUrlRequest) Execute() (*IdpDefaultUrl, *http.Response, error) {
	return r.ApiService.GetDefaultUrlExecute(r)
}
...
func (a *IdpDefaultUrlsAPIService) internalGetDefaultUrlExecute(r ApiGetDefaultUrlRequest) (*IdpDefaultUrl, *http.Response, error) {
	...
	localVarPath := localBasePath + "/idp/defaultUrls"
...
func (r ApiUpdateDefaultUrlSettingsRequest) Body(body IdpDefaultUrl) ApiUpdateDefaultUrlSettingsRequest {
	r.body = &body
	return r
}

func (r ApiUpdateDefaultUrlSettingsRequest) Execute() (*IdpDefaultUrl, *http.Response, error) {
	return r.ApiService.UpdateDefaultUrlSettingsExecute(r)
}
