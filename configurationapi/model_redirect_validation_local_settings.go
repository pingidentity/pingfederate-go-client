...
type RedirectValidationLocalSettings struct {
	...
	UriAllowList []RedirectValidationSettingsUriAllowlistEntry `json:"uriAllowList,omitempty" tfsdk:"uri_allow_list"`
}
...
// GetUriAllowList returns the UriAllowList field value if set, zero value otherwise.
func (o *RedirectValidationLocalSettings) GetUriAllowList() []RedirectValidationSettingsUriAllowlistEntry {
	if o == nil || IsNil(o.UriAllowList) {
		var ret []RedirectValidationSettingsUriAllowlistEntry
		return ret
	}
	return o.UriAllowList
}

// GetUriAllowListOk returns a tuple with the UriAllowList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RedirectValidationLocalSettings) GetUriAllowListOk() ([]RedirectValidationSettingsUriAllowlistEntry, bool) {
	if o == nil || IsNil(o.UriAllowList) {
		return nil, false
	}
	return o.UriAllowList, true
}
...
// SetUriAllowList gets a reference to the given []RedirectValidationSettingsUriAllowlistEntry and assigns it to the UriAllowList field.
...
func (o RedirectValidationLocalSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UriAllowList) {
		toSerialize["uriAllowList"] = o.UriAllowList
	}
