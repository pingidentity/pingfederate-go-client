...
`func (o *TokenToTokenMapping) GetAttributeSource() []AttributeSourceAggregation`

GetAttributeSource returns the AttributeSource field if non-nil, zero value otherwise.

### GetAttributeSourceOk

`func (o *TokenToTokenMapping) GetAttributeSourceOk() (*[]AttributeSourceAggregation, bool)`
...
`func (o *TokenToTokenMapping) SetAttributeSource(v []AttributeSourceAggregation)`

SetAttributeSource sets AttributeSource field to given value.

### HasAttributeSource

`func (o *TokenToTokenMapping) HasAttributeSource() bool`
