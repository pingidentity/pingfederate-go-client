...
type _DataStoreRepository DataStoreRepository
...
func (o *DataStoreRepository) UnmarshalJSON(bytes []byte) (err error) {
	...
	varDataStoreRepository := _DataStoreRepository{}

	err = json.Unmarshal(bytes, &varDataStoreRepository)

	if err != nil {
		return err
	}

	*o = DataStoreRepository(varDataStoreRepository)
