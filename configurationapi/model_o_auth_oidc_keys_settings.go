...
type OAuthOidcKeysSettings struct {
	...
	// Enable publishing of the dynamic key x5c parameters.
	PublishDynamicKeyX5cs            *bool                                        `json:"publishDynamicKeyX5cs,omitempty" tfsdk:"publish_dynamic_key_x5cs"`
	DynamicKeyCertificateInformation *OAuthOidcKeysSettingsCertificateInformation `json:"dynamicKeyCertificateInformation,omitempty" tfsdk:"dynamic_key_certificate_information"`
}
...
// GetPublishDynamicKeyX5cs returns the PublishDynamicKeyX5cs field value if set, zero value otherwise.
func (o *OAuthOidcKeysSettings) GetPublishDynamicKeyX5cs() bool {
	if o == nil || IsNil(o.PublishDynamicKeyX5cs) {
		var ret bool
		return ret
	}
	return *o.PublishDynamicKeyX5cs
}

// GetPublishDynamicKeyX5csOk returns a tuple with the PublishDynamicKeyX5cs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OAuthOidcKeysSettings) GetPublishDynamicKeyX5csOk() (*bool, bool) {
	if o == nil || IsNil(o.PublishDynamicKeyX5cs) {
		return nil, false
	}
	return o.PublishDynamicKeyX5cs, true
}
...
// SetPublishDynamicKeyX5cs gets a reference to the given bool and assigns it to the PublishDynamicKeyX5cs field.
func (o *OAuthOidcKeysSettings) SetPublishDynamicKeyX5cs(v bool) {
	o.PublishDynamicKeyX5cs = &v
}

// GetDynamicKeyCertificateInformation returns the DynamicKeyCertificateInformation field value if set, zero value otherwise.
func (o *OAuthOidcKeysSettings) GetDynamicKeyCertificateInformation() OAuthOidcKeysSettingsCertificateInformation {
	if o == nil || IsNil(o.DynamicKeyCertificateInformation) {
		var ret OAuthOidcKeysSettingsCertificateInformation
		return ret
	}
	return *o.DynamicKeyCertificateInformation
}

// GetDynamicKeyCertificateInformationOk returns a tuple with the DynamicKeyCertificateInformation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OAuthOidcKeysSettings) GetDynamicKeyCertificateInformationOk() (*OAuthOidcKeysSettingsCertificateInformation, bool) {
	if o == nil || IsNil(o.DynamicKeyCertificateInformation) {
		return nil, false
	}
	return o.DynamicKeyCertificateInformation, true
}
...
// SetDynamicKeyCertificateInformation gets a reference to the given OAuthOidcKeysSettingsCertificateInformation and assigns it to the DynamicKeyCertificateInformation field.
func (o *OAuthOidcKeysSettings) SetDynamicKeyCertificateInformation(v OAuthOidcKeysSettingsCertificateInformation) {
	o.DynamicKeyCertificateInformation = &v
}
...
func (o OAuthOidcKeysSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PublishDynamicKeyX5cs) {
		toSerialize["publishDynamicKeyX5cs"] = o.PublishDynamicKeyX5cs
	}
	if !IsNil(o.DynamicKeyCertificateInformation) {
		toSerialize["dynamicKeyCertificateInformation"] = o.DynamicKeyCertificateInformation
	}
