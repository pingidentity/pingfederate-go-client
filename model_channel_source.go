...
type ChannelSource struct {
	DataSource ResourceLink `json:"dataSource"`
	// the GUID attribute name.
	GuidAttributeName string `json:"guidAttributeName"`
	// Indicates whether the GUID is stored in binary format.
	GuidBinary                bool                      `json:"guidBinary"`
	ChangeDetectionSettings   ChangeDetectionSettings   `json:"changeDetectionSettings"`
	GroupMembershipDetection  GroupMembershipDetection  `json:"groupMembershipDetection"`
	AccountManagementSettings AccountManagementSettings `json:"accountManagementSettings"`
	// The base DN where the user records are located.
	BaseDn              string                 `json:"baseDn"`
	UserSourceLocation  ChannelSourceLocation  `json:"userSourceLocation"`
