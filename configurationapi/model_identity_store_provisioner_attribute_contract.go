...
func (o *IdentityStoreProvisionerAttributeContract) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varIdentityStoreProvisionerAttributeContract)
