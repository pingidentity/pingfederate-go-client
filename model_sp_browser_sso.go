...
type SpBrowserSso struct {
	...
	SsoServiceEndpoints []SpSsoServiceEndpoint `json:"ssoServiceEndpoints"`
	...
	AttributeContract          SpBrowserSsoAttributeContract `json:"attributeContract"`
	// A list of adapters that map to outgoing assertions.
	AdapterMappings []IdpAdapterAssertionMapping `json:"adapterMappings"`
	...
	AssertionLifetime                             AssertionLifetime                              `json:"assertionLifetime"`
}
