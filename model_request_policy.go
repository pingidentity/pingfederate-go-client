...
type RequestPolicy struct {
	...
	AuthenticatorRef ResourceLink  `json:"authenticatorRef"`
	UserCodePcvRef   *ResourceLink `json:"userCodePcvRef,omitempty"`
	// The transaction lifetime in seconds.
	TransactionLifetime *int64 `json:"transactionLifetime,omitempty"`
	...
	IdentityHintContract             IdentityHintContract              `json:"identityHintContract"`
