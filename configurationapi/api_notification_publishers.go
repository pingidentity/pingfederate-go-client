...
type ApiGetNotificationPublishersActionsRequest struct {
	ctx        context.Context
	ApiService *NotificationPublishersAPIService
	id         string
}

func (r ApiGetNotificationPublishersActionsRequest) Execute() (*Actions, *http.Response, error) {
	return r.ApiService.GetNotificationPublishersActionsExecute(r)
}

/*
GetNotificationPublishersActions List the actions for a notification publisher plugin instance.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id ID of the notification publisher plugin instance to which these actions belongs to.
	@return ApiGetNotificationPublishersActionsRequest
*/
func (a *NotificationPublishersAPIService) GetNotificationPublishersActions(ctx context.Context, id string) ApiGetNotificationPublishersActionsRequest {
	return ApiGetNotificationPublishersActionsRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return Actions
func (a *NotificationPublishersAPIService) GetNotificationPublishersActionsExecute(r ApiGetNotificationPublishersActionsRequest) (*Actions, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NotificationPublishersAPIService.GetNotificationPublishersActions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
