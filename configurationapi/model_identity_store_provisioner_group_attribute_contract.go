...
// checks if the IdentityStoreProvisionerGroupAttributeContract type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentityStoreProvisionerGroupAttributeContract{}
...
type _IdentityStoreProvisionerGroupAttributeContract IdentityStoreProvisionerGroupAttributeContract
...
func NewIdentityStoreProvisionerGroupAttributeContract(coreAttributes []GroupAttribute) *IdentityStoreProvisionerGroupAttributeContract {
	this := IdentityStoreProvisionerGroupAttributeContract{}
...
func (o IdentityStoreProvisionerGroupAttributeContract) MarshalJSON() ([]byte, error) {
...
func (o *IdentityStoreProvisionerGroupAttributeContract) UnmarshalJSON(bytes []byte) (err error) {
	...
	varIdentityStoreProvisionerGroupAttributeContract := _IdentityStoreProvisionerGroupAttributeContract{}

	err = json.Unmarshal(bytes, &varIdentityStoreProvisionerGroupAttributeContract)

	if err != nil {
		return err
	}

	*o = IdentityStoreProvisionerGroupAttributeContract(varIdentityStoreProvisionerGroupAttributeContract)

	return err
}

type NullableIdentityStoreProvisionerGroupAttributeContract struct {
	value *IdentityStoreProvisionerGroupAttributeContract
	isSet bool
}

func (v NullableIdentityStoreProvisionerGroupAttributeContract) Get() *IdentityStoreProvisionerGroupAttributeContract {
	return v.value
}

func (v *NullableIdentityStoreProvisionerGroupAttributeContract) Set(val *IdentityStoreProvisionerGroupAttributeContract) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentityStoreProvisionerGroupAttributeContract) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentityStoreProvisionerGroupAttributeContract) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentityStoreProvisionerGroupAttributeContract(val *IdentityStoreProvisionerGroupAttributeContract) *NullableIdentityStoreProvisionerGroupAttributeContract {
	return &NullableIdentityStoreProvisionerGroupAttributeContract{value: val, isSet: true}
}

func (v NullableIdentityStoreProvisionerGroupAttributeContract) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentityStoreProvisionerGroupAttributeContract) UnmarshalJSON(src []byte) error {
	v.isSet = true
