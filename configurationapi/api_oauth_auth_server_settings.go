...
type ApiGetCommonScopeGroupsRequest struct {
	ctx           context.Context
	ApiService    *OauthAuthServerSettingsAPIService
	page          *int64
	numberPerPage *int64
...
func (r ApiGetCommonScopeGroupsRequest) Page(page int64) ApiGetCommonScopeGroupsRequest {
	r.page = &page
	return r
}

// Number of common scope groups per page.
func (r ApiGetCommonScopeGroupsRequest) NumberPerPage(numberPerPage int64) ApiGetCommonScopeGroupsRequest {
	r.numberPerPage = &numberPerPage
	return r
}

// Filter criteria limits the common scope groups that are returned to only those that match it. The filter criteria is compared to the scope group name. The comparison is a case-insensitive partial match. No additional pattern based matching is supported.
func (r ApiGetCommonScopeGroupsRequest) Filter(filter string) ApiGetCommonScopeGroupsRequest {
	r.filter = &filter
	return r
}

// Sort order of scope group names to retrieve group by. By default, scope groups are sorted in ascending order by scope group name.
func (r ApiGetCommonScopeGroupsRequest) SortOrder(sortOrder string) ApiGetCommonScopeGroupsRequest {
	r.sortOrder = &sortOrder
	return r
}

func (r ApiGetCommonScopeGroupsRequest) Execute() (*ScopeGroupEntries, *http.Response, error) {
	return r.ApiService.GetCommonScopeGroupsExecute(r)
}

/*
GetCommonScopeGroups Get the common scope groups.

Get a list of all the common scope groups.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetCommonScopeGroupsRequest
*/
func (a *OauthAuthServerSettingsAPIService) GetCommonScopeGroups(ctx context.Context) ApiGetCommonScopeGroupsRequest {
	return ApiGetCommonScopeGroupsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return ScopeGroupEntries
func (a *OauthAuthServerSettingsAPIService) GetCommonScopeGroupsExecute(r ApiGetCommonScopeGroupsRequest) (*ScopeGroupEntries, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *ScopeGroupEntries
	)

	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalGetCommonScopeGroupsExecute(r)
		},
		&localVarReturnValue,
	)
	return localVarReturnValue, response, err
...
func (a *OauthAuthServerSettingsAPIService) internalGetCommonScopeGroupsExecute(r ApiGetCommonScopeGroupsRequest) (*ScopeGroupEntries, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OauthAuthServerSettingsAPIService.GetCommonScopeGroups")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetCommonScopesRequest struct {
	ctx                  context.Context
	ApiService           *OauthAuthServerSettingsAPIService
	page                 *int64
	numberPerPage        *int64
	filter               *string
	sortOrder            *string
	includeDefaultOpenId *bool
}

// Page number to retrieve.
func (r ApiGetCommonScopesRequest) Page(page int64) ApiGetCommonScopesRequest {
	r.page = &page
	return r
}

// Number of common scopes per page.
func (r ApiGetCommonScopesRequest) NumberPerPage(numberPerPage int64) ApiGetCommonScopesRequest {
	r.numberPerPage = &numberPerPage
	return r
}

// Filter criteria limits the common scopes that are returned to only those that match it. The filter criteria is compared to the scope name. The comparison is a case-insensitive partial match. No additional pattern based matching is supported.
func (r ApiGetCommonScopesRequest) Filter(filter string) ApiGetCommonScopesRequest {
	r.filter = &filter
	return r
}

// Sort order of scopes names to retrieve scopes by. By default, scopes are sorted in ascending order by scope name.
func (r ApiGetCommonScopesRequest) SortOrder(sortOrder string) ApiGetCommonScopesRequest {
	r.sortOrder = &sortOrder
	return r
}

// Include a default &#39;openid&#39; scope and description if one is not already configured.
func (r ApiGetCommonScopesRequest) IncludeDefaultOpenId(includeDefaultOpenId bool) ApiGetCommonScopesRequest {
	r.includeDefaultOpenId = &includeDefaultOpenId
	return r
}

func (r ApiGetCommonScopesRequest) Execute() (*ScopeEntries, *http.Response, error) {
	return r.ApiService.GetCommonScopesExecute(r)
}

/*
GetCommonScopes Get the common scopes.

Get a list of all the common scopes.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetCommonScopesRequest
*/
func (a *OauthAuthServerSettingsAPIService) GetCommonScopes(ctx context.Context) ApiGetCommonScopesRequest {
	return ApiGetCommonScopesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ScopeEntries
func (a *OauthAuthServerSettingsAPIService) GetCommonScopesExecute(r ApiGetCommonScopesRequest) (*ScopeEntries, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *ScopeEntries
	)

	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalGetCommonScopesExecute(r)
		},
		&localVarReturnValue,
	)
	return localVarReturnValue, response, err
...
func (a *OauthAuthServerSettingsAPIService) internalGetCommonScopesExecute(r ApiGetCommonScopesRequest) (*ScopeEntries, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OauthAuthServerSettingsAPIService.GetCommonScopes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.includeDefaultOpenId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeDefaultOpenId", r.includeDefaultOpenId, "")
	} else {
		var defaultValue bool = false
		r.includeDefaultOpenId = &defaultValue
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiGetExclusiveScopeGroupsRequest struct {
	ctx           context.Context
	ApiService    *OauthAuthServerSettingsAPIService
	page          *int64
	numberPerPage *int64
...
// Page number to retrieve.
func (r ApiGetExclusiveScopeGroupsRequest) Page(page int64) ApiGetExclusiveScopeGroupsRequest {
	r.page = &page
	return r
}

// Number of exclusive scope groups per page.
func (r ApiGetExclusiveScopeGroupsRequest) NumberPerPage(numberPerPage int64) ApiGetExclusiveScopeGroupsRequest {
	r.numberPerPage = &numberPerPage
	return r
}

// Filter criteria limits the exclusive scope groups that are returned to only those that match it. The filter criteria is compared to the scope group name. The comparison is a case-insensitive partial match. No additional pattern based matching is supported.
func (r ApiGetExclusiveScopeGroupsRequest) Filter(filter string) ApiGetExclusiveScopeGroupsRequest {
	r.filter = &filter
	return r
}

// Sort order of scope group names to retrieve group by. By default, scope groups are sorted in ascending order by scope group name.
func (r ApiGetExclusiveScopeGroupsRequest) SortOrder(sortOrder string) ApiGetExclusiveScopeGroupsRequest {
	r.sortOrder = &sortOrder
	return r
}

func (r ApiGetExclusiveScopeGroupsRequest) Execute() (*ScopeGroupEntries, *http.Response, error) {
	return r.ApiService.GetExclusiveScopeGroupsExecute(r)
}

/*
GetExclusiveScopeGroups Get the exclusive scope groups.

Get a list of all the exclusive scope groups.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetExclusiveScopeGroupsRequest
*/
func (a *OauthAuthServerSettingsAPIService) GetExclusiveScopeGroups(ctx context.Context) ApiGetExclusiveScopeGroupsRequest {
	return ApiGetExclusiveScopeGroupsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ScopeGroupEntries
func (a *OauthAuthServerSettingsAPIService) GetExclusiveScopeGroupsExecute(r ApiGetExclusiveScopeGroupsRequest) (*ScopeGroupEntries, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *ScopeGroupEntries
	...
	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalGetExclusiveScopeGroupsExecute(r)
		},
		&localVarReturnValue,
	)
	return localVarReturnValue, response, err
...
func (a *OauthAuthServerSettingsAPIService) internalGetExclusiveScopeGroupsExecute(r ApiGetExclusiveScopeGroupsRequest) (*ScopeGroupEntries, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OauthAuthServerSettingsAPIService.GetExclusiveScopeGroups")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetExclusiveScopesRequest struct {
	ctx           context.Context
	ApiService    *OauthAuthServerSettingsAPIService
	page          *int64
	numberPerPage *int64
...
// Page number to retrieve.
func (r ApiGetExclusiveScopesRequest) Page(page int64) ApiGetExclusiveScopesRequest {
	r.page = &page
	return r
}

// Number of exclusive scopes per page.
func (r ApiGetExclusiveScopesRequest) NumberPerPage(numberPerPage int64) ApiGetExclusiveScopesRequest {
	r.numberPerPage = &numberPerPage
	return r
}

// Filter criteria limits the exclusive scopes that are returned to only those that match it. The filter criteria is compared to the scope name. The comparison is a case-insensitive partial match. No additional pattern based matching is supported.
func (r ApiGetExclusiveScopesRequest) Filter(filter string) ApiGetExclusiveScopesRequest {
	r.filter = &filter
	return r
}

// Sort order of scopes names to retrieve scopes by. By default, scopes are sorted in ascending order by scope name.
func (r ApiGetExclusiveScopesRequest) SortOrder(sortOrder string) ApiGetExclusiveScopesRequest {
	r.sortOrder = &sortOrder
	return r
}

func (r ApiGetExclusiveScopesRequest) Execute() (*ScopeEntries, *http.Response, error) {
	return r.ApiService.GetExclusiveScopesExecute(r)
}

/*
GetExclusiveScopes Get the exclusive scopes.

Get a list of all exclusive scopes.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetExclusiveScopesRequest
*/
func (a *OauthAuthServerSettingsAPIService) GetExclusiveScopes(ctx context.Context) ApiGetExclusiveScopesRequest {
	return ApiGetExclusiveScopesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ScopeEntries
func (a *OauthAuthServerSettingsAPIService) GetExclusiveScopesExecute(r ApiGetExclusiveScopesRequest) (*ScopeEntries, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *ScopeEntries
	...
	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalGetExclusiveScopesExecute(r)
		},
		&localVarReturnValue,
	)
	return localVarReturnValue, response, err
...
func (a *OauthAuthServerSettingsAPIService) internalGetExclusiveScopesExecute(r ApiGetExclusiveScopesRequest) (*ScopeEntries, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OauthAuthServerSettingsAPIService.GetExclusiveScopes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
