...
func (r ApiCreateOauthTokenExchangeProcessorPolicyRequest) XBypassExternalValidation(xBypassExternalValidation bool) ApiCreateOauthTokenExchangeProcessorPolicyRequest {
...
// External validation will be bypassed when set to true. Default to false.
func (r ApiUpdateOauthTokenExchangeProcessorPolicyRequest) XBypassExternalValidation(xBypassExternalValidation bool) ApiUpdateOauthTokenExchangeProcessorPolicyRequest {
	r.xBypassExternalValidation = &xBypassExternalValidation
	return r
}
...
// External validation will be bypassed when set to true. Default to false.
func (r ApiUpdateOauthTokenExchangeProcessorPolicySettingsRequest) XBypassExternalValidation(xBypassExternalValidation bool) ApiUpdateOauthTokenExchangeProcessorPolicySettingsRequest {
	r.xBypassExternalValidation = &xBypassExternalValidation
	return r
}
