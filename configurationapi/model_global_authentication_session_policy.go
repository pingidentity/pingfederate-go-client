...
type _GlobalAuthenticationSessionPolicy GlobalAuthenticationSessionPolicy
...
func (o *GlobalAuthenticationSessionPolicy) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGlobalAuthenticationSessionPolicy := _GlobalAuthenticationSessionPolicy{}

	err = json.Unmarshal(bytes, &varGlobalAuthenticationSessionPolicy)

	if err != nil {
		return err
	}

	*o = GlobalAuthenticationSessionPolicy(varGlobalAuthenticationSessionPolicy)
