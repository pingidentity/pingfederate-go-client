...
type ApiDeleteClientSecondarySecretsRequest struct {
	ctx        context.Context
	ApiService *OauthClientsAPIService
	id         string
}

func (r ApiDeleteClientSecondarySecretsRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteClientSecondarySecretsExecute(r)
}

/*
DeleteClientSecondarySecrets Revoke all secondary secrets of an existing OAuth client.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id ID of the client to be updated.
	@return ApiDeleteClientSecondarySecretsRequest
*/
func (a *OauthClientsAPIService) DeleteClientSecondarySecrets(ctx context.Context, id string) ApiDeleteClientSecondarySecretsRequest {
	return ApiDeleteClientSecondarySecretsRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *OauthClientsAPIService) DeleteClientSecondarySecretsExecute(r ApiDeleteClientSecondarySecretsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OauthClientsAPIService.DeleteClientSecondarySecrets")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/oauth/clients/{id}/clientAuth/clientSecret/secondarySecrets"
...
// Sort the returned clients based on the given attribute.
func (r ApiGetOauthClientsRequest) SortBy(sortBy string) ApiGetOauthClientsRequest {
	r.sortBy = &sortBy
	return r
}

// Order of the sort.
func (r ApiGetOauthClientsRequest) SortOrder(sortOrder string) ApiGetOauthClientsRequest {
	r.sortOrder = &sortOrder
	return r
}

// Filter clients by tag name. Comma-separated list; clients that have ANY of the listed tags (case-insensitive) are returned.
func (r ApiGetOauthClientsRequest) TagName(tagName string) ApiGetOauthClientsRequest {
	r.tagName = &tagName
	return r
}
...
func (a *OauthClientsAPIService) internalGetOauthClientsExecute(r ApiGetOauthClientsRequest) (*Clients, *http.Response, error) {
	...
	if r.tagName != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "tagName", r.tagName, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
