...
// checks if the IdpAdapterDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdpAdapterDescriptor{}
...
type NullableIdpAdapterDescriptor struct {
	value *IdpAdapterDescriptor
	isSet bool
}

func (v NullableIdpAdapterDescriptor) Get() *IdpAdapterDescriptor {
	return v.value
}

func (v *NullableIdpAdapterDescriptor) Set(val *IdpAdapterDescriptor) {
	v.value = val
	v.isSet = true
}

func (v NullableIdpAdapterDescriptor) IsSet() bool {
	return v.isSet
}
...
func NewNullableIdpAdapterDescriptor(val *IdpAdapterDescriptor) *NullableIdpAdapterDescriptor {
	return &NullableIdpAdapterDescriptor{value: val, isSet: true}
}
