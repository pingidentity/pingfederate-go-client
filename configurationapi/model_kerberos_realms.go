...
// checks if the KerberosRealms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KerberosRealms{}
...
type NullableKerberosRealms struct {
	value *KerberosRealms
	isSet bool
}

func (v NullableKerberosRealms) Get() *KerberosRealms {
	return v.value
}

func (v *NullableKerberosRealms) Set(val *KerberosRealms) {
	v.value = val
	v.isSet = true
}
...
func NewNullableKerberosRealms(val *KerberosRealms) *NullableKerberosRealms {
	return &NullableKerberosRealms{value: val, isSet: true}
}
