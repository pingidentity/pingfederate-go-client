...
type _SourceTypeIdKey SourceTypeIdKey
...
func (o *SourceTypeIdKey) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSourceTypeIdKey := _SourceTypeIdKey{}

	err = json.Unmarshal(bytes, &varSourceTypeIdKey)

	if err != nil {
		return err
	}

	*o = SourceTypeIdKey(varSourceTypeIdKey)
