...
func (o *AuthenticationPolicyContractAssertionMapping) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varAuthenticationPolicyContractAssertionMapping)
