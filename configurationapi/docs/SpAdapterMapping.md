...
`func (o *SpAdapterMapping) GetAttributeSource() []AttributeSourceAggregation`

GetAttributeSource returns the AttributeSource field if non-nil, zero value otherwise.

### GetAttributeSourceOk

`func (o *SpAdapterMapping) GetAttributeSourceOk() (*[]AttributeSourceAggregation, bool)`
...
`func (o *SpAdapterMapping) SetAttributeSource(v []AttributeSourceAggregation)`

SetAttributeSource sets AttributeSource field to given value.

### HasAttributeSource

`func (o *SpAdapterMapping) HasAttributeSource() bool`
