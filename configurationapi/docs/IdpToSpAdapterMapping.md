...
`func (o *IdpToSpAdapterMapping) GetAttributeSource() []AttributeSourceAggregation`

GetAttributeSource returns the AttributeSource field if non-nil, zero value otherwise.

### GetAttributeSourceOk

`func (o *IdpToSpAdapterMapping) GetAttributeSourceOk() (*[]AttributeSourceAggregation, bool)`
...
`func (o *IdpToSpAdapterMapping) SetAttributeSource(v []AttributeSourceAggregation)`

SetAttributeSource sets AttributeSource field to given value.

### HasAttributeSource

`func (o *IdpToSpAdapterMapping) HasAttributeSource() bool`
