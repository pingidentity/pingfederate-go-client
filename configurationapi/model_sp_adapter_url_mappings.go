...
// checks if the SpAdapterUrlMappings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpAdapterUrlMappings{}
...
type NullableSpAdapterUrlMappings struct {
	value *SpAdapterUrlMappings
	isSet bool
}

func (v NullableSpAdapterUrlMappings) Get() *SpAdapterUrlMappings {
	return v.value
}

func (v *NullableSpAdapterUrlMappings) Set(val *SpAdapterUrlMappings) {
	v.value = val
	v.isSet = true
}

func (v NullableSpAdapterUrlMappings) IsSet() bool {
	return v.isSet
}
...
func NewNullableSpAdapterUrlMappings(val *SpAdapterUrlMappings) *NullableSpAdapterUrlMappings {
	return &NullableSpAdapterUrlMappings{value: val, isSet: true}
}
