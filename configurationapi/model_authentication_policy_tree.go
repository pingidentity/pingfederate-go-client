...
type AuthenticationPolicyTree struct {
	...
	RootNode AuthenticationPolicyTreeNode `json:"rootNode" tfsdk:"root_node"`
...
// GetRootNode returns the RootNode field value
...
// GetRootNodeOk returns a tuple with the RootNode field value
// and a boolean to check if the value has been set.
