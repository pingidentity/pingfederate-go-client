...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **string** | The ID of the tag. The ID can only contain alphanumeric characters, dash, dot and underscore. The ID is system-assigned if not specified. | [optional] 
**Name** | **string** | The name of the tag. | 
**Description** | Pointer to **string** | The description of the tag. | [optional] 
**CreatedAt** | Pointer to **time.Time** | The time when the tag was created. | [optional] [readonly] 
**UpdatedAt** | Pointer to **time.Time** | The time when the tag was last updated. | [optional] [readonly] 
