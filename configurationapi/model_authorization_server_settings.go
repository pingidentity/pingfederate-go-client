...
type AuthorizationServerSettings struct {
	...
	RequireOfflineAccessScopeToIssueRefreshTokens *bool `json:"requireOfflineAccessScopeToIssueRefreshTokens,omitempty" tfsdk:"require_offline_access_scope_to_issue_refresh_tokens"`
	// Determines whether offline_access requires the prompt parameter value be 'consent' or not. The value will be reset to default if the 'requireOfflineAccessScopeToIssueRefreshTokens' attribute is set to false. The default value is false.
	OfflineAccessRequireConsentPrompt *bool `json:"offlineAccessRequireConsentPrompt,omitempty" tfsdk:"offline_access_require_consent_prompt"`
	...
	RefreshRollingIntervalTimeUnit *string `json:"refreshRollingIntervalTimeUnit,omitempty" tfsdk:"refresh_rolling_interval_time_unit"`
...
// SetRequireOfflineAccessScopeToIssueRefreshTokens gets a reference to the given bool and assigns it to the RequireOfflineAccessScopeToIssueRefreshTokens field.
...
// SetOfflineAccessRequireConsentPrompt gets a reference to the given bool and assigns it to the OfflineAccessRequireConsentPrompt field.
...
// GetRefreshRollingIntervalTimeUnit returns the RefreshRollingIntervalTimeUnit field value if set, zero value otherwise.
func (o *AuthorizationServerSettings) GetRefreshRollingIntervalTimeUnit() string {
	if o == nil || IsNil(o.RefreshRollingIntervalTimeUnit) {
		var ret string
		return ret
	}
	return *o.RefreshRollingIntervalTimeUnit
}

// GetRefreshRollingIntervalTimeUnitOk returns a tuple with the RefreshRollingIntervalTimeUnit field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuthorizationServerSettings) GetRefreshRollingIntervalTimeUnitOk() (*string, bool) {
	if o == nil || IsNil(o.RefreshRollingIntervalTimeUnit) {
		return nil, false
	}
	return o.RefreshRollingIntervalTimeUnit, true
}
...
// SetRefreshRollingIntervalTimeUnit gets a reference to the given string and assigns it to the RefreshRollingIntervalTimeUnit field.
func (o *AuthorizationServerSettings) SetRefreshRollingIntervalTimeUnit(v string) {
	o.RefreshRollingIntervalTimeUnit = &v
}
...
// GetEnableCookielessUserAuthorizationAuthenticationApi returns the EnableCookielessUserAuthorizationAuthenticationApi field value if set, zero value otherwise.
func (o *AuthorizationServerSettings) GetEnableCookielessUserAuthorizationAuthenticationApi() bool {
	if o == nil || IsNil(o.EnableCookielessUserAuthorizationAuthenticationApi) {
		var ret bool
		return ret
	}
	return *o.EnableCookielessUserAuthorizationAuthenticationApi
}

// GetEnableCookielessUserAuthorizationAuthenticationApiOk returns a tuple with the EnableCookielessUserAuthorizationAuthenticationApi field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuthorizationServerSettings) GetEnableCookielessUserAuthorizationAuthenticationApiOk() (*bool, bool) {
	if o == nil || IsNil(o.EnableCookielessUserAuthorizationAuthenticationApi) {
		return nil, false
	}
	return o.EnableCookielessUserAuthorizationAuthenticationApi, true
}
...
// SetEnableCookielessUserAuthorizationAuthenticationApi gets a reference to the given bool and assigns it to the EnableCookielessUserAuthorizationAuthenticationApi field.
...
func (o AuthorizationServerSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RefreshRollingIntervalTimeUnit) {
		toSerialize["refreshRollingIntervalTimeUnit"] = o.RefreshRollingIntervalTimeUnit
	}
