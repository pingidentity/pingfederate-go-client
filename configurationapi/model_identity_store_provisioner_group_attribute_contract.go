...
func (o *IdentityStoreProvisionerGroupAttributeContract) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varIdentityStoreProvisionerGroupAttributeContract)
