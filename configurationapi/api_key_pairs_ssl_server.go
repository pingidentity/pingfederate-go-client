...
type ApiLinkSslServerPrivateKeyAndCertRequest struct {
	ctx        context.Context
	ApiService *KeyPairsSslServerAPIService
	body       *KeyPairLink
}
...
func (r ApiLinkSslServerPrivateKeyAndCertRequest) Body(body KeyPairLink) ApiLinkSslServerPrivateKeyAndCertRequest {
	r.body = &body
	return r
}

func (r ApiLinkSslServerPrivateKeyAndCertRequest) Execute() (*http.Response, error) {
	return r.ApiService.LinkSslServerPrivateKeyAndCertExecute(r)
}

/*
LinkSslServerPrivateKeyAndCert Import a certificate to be used by PingFederate and link it to a private key that exists on an HSM.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiLinkSslServerPrivateKeyAndCertRequest
*/
func (a *KeyPairsSslServerAPIService) LinkSslServerPrivateKeyAndCert(ctx context.Context) ApiLinkSslServerPrivateKeyAndCertRequest {
	return ApiLinkSslServerPrivateKeyAndCertRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *KeyPairsSslServerAPIService) LinkSslServerPrivateKeyAndCertExecute(r ApiLinkSslServerPrivateKeyAndCertRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KeyPairsSslServerAPIService.LinkSslServerPrivateKeyAndCert")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/keyPairs/sslServer/link"
