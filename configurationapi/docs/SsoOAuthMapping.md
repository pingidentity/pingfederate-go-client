...
`func (o *SsoOAuthMapping) GetAttributeSource() []AttributeSourceAggregation`

GetAttributeSource returns the AttributeSource field if non-nil, zero value otherwise.

### GetAttributeSourceOk

`func (o *SsoOAuthMapping) GetAttributeSourceOk() (*[]AttributeSourceAggregation, bool)`
...
`func (o *SsoOAuthMapping) SetAttributeSource(v []AttributeSourceAggregation)`

SetAttributeSource sets AttributeSource field to given value.

### HasAttributeSource

`func (o *SsoOAuthMapping) HasAttributeSource() bool`
