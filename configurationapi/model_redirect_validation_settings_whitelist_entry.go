...
type _RedirectValidationSettingsWhitelistEntry RedirectValidationSettingsWhitelistEntry
...
func (o *RedirectValidationSettingsWhitelistEntry) UnmarshalJSON(bytes []byte) (err error) {
	...
	varRedirectValidationSettingsWhitelistEntry := _RedirectValidationSettingsWhitelistEntry{}

	err = json.Unmarshal(bytes, &varRedirectValidationSettingsWhitelistEntry)

	if err != nil {
		return err
	}

	*o = RedirectValidationSettingsWhitelistEntry(varRedirectValidationSettingsWhitelistEntry)
