...
type _AttributeMapping AttributeMapping
...
func (o *AttributeMapping) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAttributeMapping := _AttributeMapping{}

	err = json.Unmarshal(bytes, &varAttributeMapping)

	if err != nil {
		return err
	}

	*o = AttributeMapping(varAttributeMapping)
