...
type RequestPolicy struct {
	...
	TransactionLifetime int64 `json:"transactionLifetime" tfsdk:"transaction_lifetime"`
	...
	IdentityHintMapping              AttributeMapping                  `json:"identityHintMapping" tfsdk:"identity_hint_mapping"`
...
// GetTransactionLifetime returns the TransactionLifetime field value
...
// GetTransactionLifetimeOk returns a tuple with the TransactionLifetime field value
// and a boolean to check if the value has been set.
...
// SetTransactionLifetime sets field value
...
// GetIdentityHintMapping returns the IdentityHintMapping field value
...
// GetIdentityHintMappingOk returns a tuple with the IdentityHintMapping field value
// and a boolean to check if the value has been set.
...
// SetIdentityHintMapping sets field value
