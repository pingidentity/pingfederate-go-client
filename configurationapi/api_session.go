...
type ApiGetSessionQuotaSettingsRequest struct {
	ctx        context.Context
	ApiService *SessionAPIService
}

func (r ApiGetSessionQuotaSettingsRequest) Execute() (*SessionQuotaSettings, *http.Response, error) {
	return r.ApiService.GetSessionQuotaSettingsExecute(r)
}

/*
GetSessionQuotaSettings Get the session quota settings.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetSessionQuotaSettingsRequest
*/
func (a *SessionAPIService) GetSessionQuotaSettings(ctx context.Context) ApiGetSessionQuotaSettingsRequest {
	return ApiGetSessionQuotaSettingsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return SessionQuotaSettings
func (a *SessionAPIService) GetSessionQuotaSettingsExecute(r ApiGetSessionQuotaSettingsRequest) (*SessionQuotaSettings, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *SessionQuotaSettings
	)

	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalGetSessionQuotaSettingsExecute(r)
		},
		&localVarReturnValue,
	)
	return localVarReturnValue, response, err
...
func (a *SessionAPIService) internalGetSessionQuotaSettingsExecute(r ApiGetSessionQuotaSettingsRequest) (*SessionQuotaSettings, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SessionAPIService.GetSessionQuotaSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/session/quotas"
...
type ApiUpdateSessionQuotaSettingsRequest struct {
	ctx        context.Context
	ApiService *SessionAPIService
	body       *SessionQuotaSettings
}

// Session quota settings.
func (r ApiUpdateSessionQuotaSettingsRequest) Body(body SessionQuotaSettings) ApiUpdateSessionQuotaSettingsRequest {
	r.body = &body
	return r
}

func (r ApiUpdateSessionQuotaSettingsRequest) Execute() (*SessionQuotaSettings, *http.Response, error) {
	return r.ApiService.UpdateSessionQuotaSettingsExecute(r)
}

/*
UpdateSessionQuotaSettings Update the session quota settings.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiUpdateSessionQuotaSettingsRequest
*/
func (a *SessionAPIService) UpdateSessionQuotaSettings(ctx context.Context) ApiUpdateSessionQuotaSettingsRequest {
	return ApiUpdateSessionQuotaSettingsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return SessionQuotaSettings
func (a *SessionAPIService) UpdateSessionQuotaSettingsExecute(r ApiUpdateSessionQuotaSettingsRequest) (*SessionQuotaSettings, *http.Response, error) {
	var (
		err                 error
		response            *http.Response
		localVarReturnValue *SessionQuotaSettings
	...
	response, err = processResponse(
		func() (any, *http.Response, error) {
			return r.ApiService.internalUpdateSessionQuotaSettingsExecute(r)
		},
		&localVarReturnValue,
	)
	return localVarReturnValue, response, err
...
func (a *SessionAPIService) internalUpdateSessionQuotaSettingsExecute(r ApiUpdateSessionQuotaSettingsRequest) (*SessionQuotaSettings, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SessionAPIService.UpdateSessionQuotaSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
