...
func NewProcessorPolicyToPersistentGrantMapping(attributeContractFulfillment map[string]AttributeFulfillmentValue, processorPolicyRef ResourceLink) *ProcessorPolicyToPersistentGrantMapping {
