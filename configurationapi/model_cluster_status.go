...
type ClusterStatus struct {
	...
	// Index of the current node in the cluster.
	CurrentNodeIndex *int64 `json:"currentNodeIndex,omitempty" tfsdk:"current_node_index"`
}
...
// GetCurrentNodeIndex returns the CurrentNodeIndex field value if set, zero value otherwise.
func (o *ClusterStatus) GetCurrentNodeIndex() int64 {
	if o == nil || IsNil(o.CurrentNodeIndex) {
		var ret int64
		return ret
	}
	return *o.CurrentNodeIndex
}

// GetCurrentNodeIndexOk returns a tuple with the CurrentNodeIndex field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClusterStatus) GetCurrentNodeIndexOk() (*int64, bool) {
	if o == nil || IsNil(o.CurrentNodeIndex) {
		return nil, false
	}
	return o.CurrentNodeIndex, true
}
...
// SetCurrentNodeIndex gets a reference to the given int64 and assigns it to the CurrentNodeIndex field.
func (o *ClusterStatus) SetCurrentNodeIndex(v int64) {
	o.CurrentNodeIndex = &v
}
...
func (o ClusterStatus) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CurrentNodeIndex) {
		toSerialize["currentNodeIndex"] = o.CurrentNodeIndex
	}
