...
// checks if the PasswordCredentialValidators type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PasswordCredentialValidators{}
...
func NewPasswordCredentialValidators() *PasswordCredentialValidators {
	this := PasswordCredentialValidators{}
	return &this
}
...
func (o *PasswordCredentialValidators) GetItems() []PasswordCredentialValidator {
	if o == nil || IsNil(o.Items) {
		var ret []PasswordCredentialValidator
		return ret
	}
	return o.Items
}
...
type NullablePasswordCredentialValidators struct {
	value *PasswordCredentialValidators
	isSet bool
}

func (v NullablePasswordCredentialValidators) Get() *PasswordCredentialValidators {
	return v.value
}

func (v *NullablePasswordCredentialValidators) Set(val *PasswordCredentialValidators) {
	v.value = val
	v.isSet = true
}

func (v NullablePasswordCredentialValidators) IsSet() bool {
	return v.isSet
}

func (v *NullablePasswordCredentialValidators) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePasswordCredentialValidators(val *PasswordCredentialValidators) *NullablePasswordCredentialValidators {
	return &NullablePasswordCredentialValidators{value: val, isSet: true}
}
