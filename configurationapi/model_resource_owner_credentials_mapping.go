...
type _ResourceOwnerCredentialsMapping ResourceOwnerCredentialsMapping
...
func (o *ResourceOwnerCredentialsMapping) UnmarshalJSON(bytes []byte) (err error) {
	...
	varResourceOwnerCredentialsMapping := _ResourceOwnerCredentialsMapping{}

	err = json.Unmarshal(bytes, &varResourceOwnerCredentialsMapping)

	if err != nil {
		return err
	}

	*o = ResourceOwnerCredentialsMapping(varResourceOwnerCredentialsMapping)
