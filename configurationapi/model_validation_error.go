...
type ValidationError struct {
	...
	// The path to the model field to which the error relates, if one exists. In a user interface, this attribute can be used to associate the error with a specific location on the page. If models are nested, dot-notation is used to specify fields in sub-models.
