...
// checks if the MetadataUrls type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetadataUrls{}
...
func (v NullableMetadataUrls) Get() *MetadataUrls {
	return v.value
}
...
func NewNullableMetadataUrls(val *MetadataUrls) *NullableMetadataUrls {
	return &NullableMetadataUrls{value: val, isSet: true}
}
