...
type _BackChannelAuth BackChannelAuth
...
func (o *BackChannelAuth) UnmarshalJSON(bytes []byte) (err error) {
	...
	varBackChannelAuth := _BackChannelAuth{}

	err = json.Unmarshal(bytes, &varBackChannelAuth)

	if err != nil {
		return err
	}

	*o = BackChannelAuth(varBackChannelAuth)
