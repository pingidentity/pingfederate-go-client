...
type PingOneForEnterpriseSettings struct {
	...
	CurrentAuthnKeyCreationTime *time.Time `json:"currentAuthnKeyCreationTime,omitempty"`
	// A read only field indicating the creation time of the previous authentication key.
	PreviousAuthnKeyCreationTime *time.Time `json:"previousAuthnKeyCreationTime,omitempty"`
