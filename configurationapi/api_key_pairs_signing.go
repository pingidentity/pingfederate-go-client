...
type ApiLinkSigningPrivateKeyAndCertRequest struct {
	ctx        context.Context
	ApiService *KeyPairsSigningAPIService
	body       *KeyPairLink
}
...
func (r ApiLinkSigningPrivateKeyAndCertRequest) Body(body KeyPairLink) ApiLinkSigningPrivateKeyAndCertRequest {
	r.body = &body
	return r
}

func (r ApiLinkSigningPrivateKeyAndCertRequest) Execute() (*http.Response, error) {
	return r.ApiService.LinkSigningPrivateKeyAndCertExecute(r)
}

/*
LinkSigningPrivateKeyAndCert Import a certificate to be used by PingFederate and link it to a private key that exists on an HSM.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiLinkSigningPrivateKeyAndCertRequest
*/
func (a *KeyPairsSigningAPIService) LinkSigningPrivateKeyAndCert(ctx context.Context) ApiLinkSigningPrivateKeyAndCertRequest {
	return ApiLinkSigningPrivateKeyAndCertRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *KeyPairsSigningAPIService) LinkSigningPrivateKeyAndCertExecute(r ApiLinkSigningPrivateKeyAndCertRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodPost
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "KeyPairsSigningAPIService.LinkSigningPrivateKeyAndCert")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/keyPairs/signing/link"
