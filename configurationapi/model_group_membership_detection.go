...
type GroupMembershipDetection struct {
	...
	GroupMemberAttributeName *string `json:"groupMemberAttributeName,omitempty" tfsdk:"group_member_attribute_name"`
}
...
// GetGroupMemberAttributeName returns the GroupMemberAttributeName field value if set, zero value otherwise.
func (o *GroupMembershipDetection) GetGroupMemberAttributeName() string {
	if o == nil || IsNil(o.GroupMemberAttributeName) {
		var ret string
		return ret
	}
...
// GetGroupMemberAttributeNameOk returns a tuple with the GroupMemberAttributeName field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetGroupMemberAttributeName gets a reference to the given string and assigns it to the GroupMemberAttributeName field.
...
func (o GroupMembershipDetection) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GroupMemberAttributeName) {
