...
type SpConnection struct {
	...
	OauthTokenExchangeSettings *SpOAuthTokenExchangeSettings `json:"oauthTokenExchangeSettings,omitempty" tfsdk:"oauth_token_exchange_settings"`
}
...
// GetOauthTokenExchangeSettings returns the OauthTokenExchangeSettings field value if set, zero value otherwise.
func (o *SpConnection) GetOauthTokenExchangeSettings() SpOAuthTokenExchangeSettings {
	if o == nil || IsNil(o.OauthTokenExchangeSettings) {
		var ret SpOAuthTokenExchangeSettings
		return ret
	}
	return *o.OauthTokenExchangeSettings
}

// GetOauthTokenExchangeSettingsOk returns a tuple with the OauthTokenExchangeSettings field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SpConnection) GetOauthTokenExchangeSettingsOk() (*SpOAuthTokenExchangeSettings, bool) {
	if o == nil || IsNil(o.OauthTokenExchangeSettings) {
		return nil, false
	}
	return o.OauthTokenExchangeSettings, true
}
...
// SetOauthTokenExchangeSettings gets a reference to the given SpOAuthTokenExchangeSettings and assigns it to the OauthTokenExchangeSettings field.
func (o *SpConnection) SetOauthTokenExchangeSettings(v SpOAuthTokenExchangeSettings) {
	o.OauthTokenExchangeSettings = &v
}
...
func (o SpConnection) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OauthTokenExchangeSettings) {
		toSerialize["oauthTokenExchangeSettings"] = o.OauthTokenExchangeSettings
	}
