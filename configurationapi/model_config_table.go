...
func (o *ConfigTable) UnmarshalJSON(bytes []byte) (err error) {
	...
	varConfigTable := _ConfigTable{}

	err = json.Unmarshal(bytes, &varConfigTable)

	if err != nil {
		return err
	}

	*o = ConfigTable(varConfigTable)
