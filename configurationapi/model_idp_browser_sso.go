...
type IdpBrowserSso struct {
	...
	// Specify whether errors received from the IdP should be passed through to the target application.
	PassthroughErrors *bool `json:"passthroughErrors,omitempty" tfsdk:"passthrough_errors"`
...
// GetPassthroughErrors returns the PassthroughErrors field value if set, zero value otherwise.
func (o *IdpBrowserSso) GetPassthroughErrors() bool {
	if o == nil || IsNil(o.PassthroughErrors) {
		var ret bool
		return ret
	}
	return *o.PassthroughErrors
}

// GetPassthroughErrorsOk returns a tuple with the PassthroughErrors field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IdpBrowserSso) GetPassthroughErrorsOk() (*bool, bool) {
	if o == nil || IsNil(o.PassthroughErrors) {
		return nil, false
	}
	return o.PassthroughErrors, true
}
...
// SetPassthroughErrors gets a reference to the given bool and assigns it to the PassthroughErrors field.
func (o *IdpBrowserSso) SetPassthroughErrors(v bool) {
	o.PassthroughErrors = &v
}
...
func (o IdpBrowserSso) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PassthroughErrors) {
		toSerialize["passthroughErrors"] = o.PassthroughErrors
	}
