...
// checks if the TokenProcessorDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenProcessorDescriptor{}
...
type NullableTokenProcessorDescriptor struct {
	value *TokenProcessorDescriptor
	isSet bool
}

func (v NullableTokenProcessorDescriptor) Get() *TokenProcessorDescriptor {
	return v.value
}

func (v *NullableTokenProcessorDescriptor) Set(val *TokenProcessorDescriptor) {
	v.value = val
	v.isSet = true
}

func (v NullableTokenProcessorDescriptor) IsSet() bool {
	return v.isSet
}

func (v *NullableTokenProcessorDescriptor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokenProcessorDescriptor(val *TokenProcessorDescriptor) *NullableTokenProcessorDescriptor {
	return &NullableTokenProcessorDescriptor{value: val, isSet: true}
}
