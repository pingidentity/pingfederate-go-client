...
// checks if the JdbcAttributeSourceAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JdbcAttributeSourceAllOf{}

// JdbcAttributeSourceAllOf The configured settings used to look up attributes from a JDBC data store.
type JdbcAttributeSourceAllOf struct {
...
func (o JdbcAttributeSourceAllOf) MarshalJSON() ([]byte, error) {
...
func (o JdbcAttributeSourceAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableJdbcAttributeSourceAllOf struct {
	value *JdbcAttributeSourceAllOf
	isSet bool
}

func (v NullableJdbcAttributeSourceAllOf) Get() *JdbcAttributeSourceAllOf {
	return v.value
}

func (v *NullableJdbcAttributeSourceAllOf) Set(val *JdbcAttributeSourceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableJdbcAttributeSourceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableJdbcAttributeSourceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJdbcAttributeSourceAllOf(val *JdbcAttributeSourceAllOf) *NullableJdbcAttributeSourceAllOf {
	return &NullableJdbcAttributeSourceAllOf{value: val, isSet: true}
}

func (v NullableJdbcAttributeSourceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJdbcAttributeSourceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
