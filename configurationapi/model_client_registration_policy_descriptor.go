...
// checks if the ClientRegistrationPolicyDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientRegistrationPolicyDescriptor{}
...
func NewClientRegistrationPolicyDescriptor() *ClientRegistrationPolicyDescriptor {
	this := ClientRegistrationPolicyDescriptor{}
	return &this
}
...
type NullableClientRegistrationPolicyDescriptor struct {
	value *ClientRegistrationPolicyDescriptor
	isSet bool
}

func (v NullableClientRegistrationPolicyDescriptor) Get() *ClientRegistrationPolicyDescriptor {
	return v.value
}

func (v *NullableClientRegistrationPolicyDescriptor) Set(val *ClientRegistrationPolicyDescriptor) {
	v.value = val
	v.isSet = true
}

func (v NullableClientRegistrationPolicyDescriptor) IsSet() bool {
	return v.isSet
}

func (v *NullableClientRegistrationPolicyDescriptor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClientRegistrationPolicyDescriptor(val *ClientRegistrationPolicyDescriptor) *NullableClientRegistrationPolicyDescriptor {
	return &NullableClientRegistrationPolicyDescriptor{value: val, isSet: true}
}

func (v NullableClientRegistrationPolicyDescriptor) MarshalJSON() ([]byte, error) {
