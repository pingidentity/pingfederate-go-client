...
type IdpConnection struct {
	...
	JwtBearerGrantProcessor       *IdpJwtBearerGrantProcessor    `json:"jwtBearerGrantProcessor,omitempty" tfsdk:"jwt_bearer_grant_processor"`
...
// GetJwtBearerGrantProcessor returns the JwtBearerGrantProcessor field value if set, zero value otherwise.
func (o *IdpConnection) GetJwtBearerGrantProcessor() IdpJwtBearerGrantProcessor {
	if o == nil || IsNil(o.JwtBearerGrantProcessor) {
		var ret IdpJwtBearerGrantProcessor
		return ret
	}
	return *o.JwtBearerGrantProcessor
}

// GetJwtBearerGrantProcessorOk returns a tuple with the JwtBearerGrantProcessor field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IdpConnection) GetJwtBearerGrantProcessorOk() (*IdpJwtBearerGrantProcessor, bool) {
	if o == nil || IsNil(o.JwtBearerGrantProcessor) {
		return nil, false
	}
	return o.JwtBearerGrantProcessor, true
}
...
// SetJwtBearerGrantProcessor gets a reference to the given IdpJwtBearerGrantProcessor and assigns it to the JwtBearerGrantProcessor field.
func (o *IdpConnection) SetJwtBearerGrantProcessor(v IdpJwtBearerGrantProcessor) {
	o.JwtBearerGrantProcessor = &v
}
...
func (o IdpConnection) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.JwtBearerGrantProcessor) {
		toSerialize["jwtBearerGrantProcessor"] = o.JwtBearerGrantProcessor
	}
