...
func (r ApiGetMappingsRequest) Execute() ([]AccessTokenMapping, *http.Response, error) {
...
//
//	@return []AccessTokenMapping
func (a *OauthAccessTokenMappingsAPIService) GetMappingsExecute(r ApiGetMappingsRequest) ([]AccessTokenMapping, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
