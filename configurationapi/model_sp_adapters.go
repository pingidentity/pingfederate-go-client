...
// checks if the SpAdapters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpAdapters{}
...
func NewNullableSpAdapters(val *SpAdapters) *NullableSpAdapters {
	return &NullableSpAdapters{value: val, isSet: true}
}
