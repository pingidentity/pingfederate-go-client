...
type ServerSettings struct {
	...
	EmailServers      *EmailServerSettings  `json:"emailServers,omitempty" tfsdk:"email_servers"`
}
...
// SetEmailServers gets a reference to the given EmailServerSettings and assigns it to the EmailServers field.
...
func (o ServerSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EmailServers) {
		toSerialize["emailServers"] = o.EmailServers
	}
