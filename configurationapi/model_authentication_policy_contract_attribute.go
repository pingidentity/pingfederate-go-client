...
type _AuthenticationPolicyContractAttribute AuthenticationPolicyContractAttribute
...
func (o *AuthenticationPolicyContractAttribute) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAuthenticationPolicyContractAttribute := _AuthenticationPolicyContractAttribute{}

	err = json.Unmarshal(bytes, &varAuthenticationPolicyContractAttribute)

	if err != nil {
		return err
	}

	*o = AuthenticationPolicyContractAttribute(varAuthenticationPolicyContractAttribute)
