...
// checks if the AuthenticationPolicyContracts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthenticationPolicyContracts{}
...
func NewAuthenticationPolicyContracts() *AuthenticationPolicyContracts {
	this := AuthenticationPolicyContracts{}
	return &this
}
...
func (o *AuthenticationPolicyContracts) GetItems() []AuthenticationPolicyContract {
	if o == nil || IsNil(o.Items) {
		var ret []AuthenticationPolicyContract
		return ret
	}
	return o.Items
}
...
type NullableAuthenticationPolicyContracts struct {
	value *AuthenticationPolicyContracts
	isSet bool
}

func (v NullableAuthenticationPolicyContracts) Get() *AuthenticationPolicyContracts {
	return v.value
}

func (v *NullableAuthenticationPolicyContracts) Set(val *AuthenticationPolicyContracts) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthenticationPolicyContracts) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthenticationPolicyContracts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthenticationPolicyContracts(val *AuthenticationPolicyContracts) *NullableAuthenticationPolicyContracts {
	return &NullableAuthenticationPolicyContracts{value: val, isSet: true}
}
